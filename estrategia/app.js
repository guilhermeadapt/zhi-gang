...
(function () {
  ...
  const I18N = {
    pt: {
      ...
      tabTable:'Tabela', tabBoard:'Board', bdAuto:'⚙ Auto-preencher', bdEmpty:'Esvaziar PTs', groupClass:'⊟ Por classe', bdLegend:'Arraste cada jogador para a PT, para as <b>reservas da PT</b> ou reservas gerais. Clique num jogador para função, tarja e flags. Alvo: <b>1 Tank · 1 Healer · 3 DPS</b>.', titulars:'Titulares', ptReserves:'Reservas da PT', genReserves:'Reservas gerais', obsPh:'Observações da PT…', roleLbl:'Função', ptLbl:'PT', replaceLbl:'Replace', repOf:'Replace de', swapWith:'Trocar com', swapHint:'Trocar titular ⇄ replace:', repGone:'O alvo do replace saiu do roster — replace limpo', copyBoard:'🔗 Copiar board', boardShareTitle:'Link do BOARD (players e PTs, sem cenários) — mande no Discord:', confirmBoard:'Este link traz só o BOARD (players, PTs, reservas). Aplicar por cima do plano atual? Os cenários e o mapa são mantidos.', boardLoaded:'Board do link aplicado ✓', confirmSaveBoard:'Você mexeu no board. SALVAR as alterações antes de fechar? (Cancelar descarta)', allToRes:'Jogar todos os disponíveis para reservas',
  ...
  const GUIDE = {
    pt: { title: 'Guia do Game Plan', html: `<p class="guide-lead">Uma ferramenta pra montar e apresentar a estratégia da GvG em cima do mapa. Tudo é salvo automaticamente <b>neste navegador</b>. Abaixo, o essencial e principalmente os recursos que <b>não são óbvios</b> pela interface.</p>
<section class="guide-sec"><h3>1 · A ideia — Fases &amp; Cenários</h3><p>Cada <b>cenário</b> é uma "foto" do mapa (posições, desenhos, objetivos up, vida). Você monta uma sequência de fases (ex.: <i>Abertura → Meio → Boss</i>) e navega por elas na régua embaixo (botão <b>Fases</b>). Apresentar roda essa sequência em tela cheia.</p><p>No editor de fases (embaixo) dá pra dar um <b>nome</b>, uma <b>condição</b> e o <b>tempo de jogo</b> daquele cenário (campo <b>⏱ 30m</b>) — ele vira um selo na régua e na apresentação, deixando claro que aquela cena é aos 30m, a outra aos 25m, etc.</p><p>O botão de <b>alvo</b> (📍) nos controles de zoom <b>salva o zoom/enquadramento</b> daquela cena — ao voltar pra ela (inclusive apresentando), o mapa volta pra esse zoom. Toque de novo pra limpar.</p></section>
<section class="guide-sec highlight"><h3>2 · Montar os times — subir o roster <span class="tagimp">pouco óbvio</span></h3><p>Em <b>Roster → Editar roster</b> você cola a inscrição do Discord. Pra pegar o JSON da inscrição:</p><ol><li>Abra a <b>mensagem de inscrição do Board</b> no Discord.</li><li>No <b>rodapé</b> dela, clique no link <b>"Web view"</b>.</li><li>Na página que abrir, clique em <b>"JSON"</b> no <b>cabeçalho</b> do Board.</li><li>Selecione tudo com <b>Ctrl+A</b> e copie (<b>Ctrl+C</b>).</li><li>Cole no campo <b>Montagem do Discord</b> e clique <b>Processar</b> ou <b>Mesclar</b>.</li></ol><ul><li><b>Processar (substitui):</b> troca o roster inteiro pelo que você colou.</li><li><b>Mesclar com atual:</b> mantém quem já está montado (PT, tarjas, flags), adiciona os novos como reserva e <b>remove</b> quem não aparece no novo JSON — ideal pra atualizar a lista sem refazer o board.</li><li>Reconhece automático: <i>Ranged/Melee → DPS</i>, <i>Absence → ausente</i>, <i>Bench/Tentative → reserva</i>. Depois use <b>Auto-montar PTs</b> ou arraste na aba <b>Board</b>.</li><li><b>Colocar no mapa:</b> arraste uma <b>PT</b> inteira da lista, ou troque pra aba <b>Players</b> e arraste um jogador. O número na bola da PT mostra <b>quantos ainda estão na formação</b> — ao destacar alguém, esse número cai.</li></ul></section>
<section class="guide-sec highlight"><h3>3 · Gestos no token do jogador <span class="tagimp">pouco óbvio</span></h3><ul><li><b>1 toque</b> = abre o menu (vida, morto, vincular, travar, remover).</li><li><b>Segurar (~0,4s)</b> = esconde/mostra o nome (escondido, vira uma bolinha com o nº da PT).</li><li><b>Segurar 5s</b> = joga o nome pro lado do ícone.</li><li><b>2 toques</b> = remove o token do mapa.</li></ul></section>
<section class="guide-sec highlight"><h3>4 · Vínculos (setas) <span class="tagimp">pouco óbvio</span></h3><p>Abra o menu de um ícone e clique <b>Vincular</b> → toque em <b>outro ícone</b> pra criar a seta. Ela fica armada na origem, então dá pra <b>encadear</b> várias. <b>Clique na seta</b> pra remover. A fina é a amarração PT↔membro; as grossas são estratégicas.</p></section>
<section class="guide-sec highlight"><h3>5 · Foco / spotlight <span class="tagimp">pouco óbvio</span></h3><p>Ferramenta de <b>alvo</b> na barra esquerda: <b>arraste</b> pra destacar uma área — o resto escurece. Dá pra ter <b>vários focos</b>. Na ferramenta <b>Selecionar</b>, encoste na <b>borda</b> de um foco pra <b>arrastá-lo</b> (mover) e aparecer o <b>✕</b> pra remover — o meio continua clicável pros tokens. Ao selecionar um foco: a <b>alça</b> em cima gira, o botão de <b>formato</b> alterna retângulo/elipse e o <b>✕</b> remove, e as <b>alças de canto</b> redimensionam. Botões na barra: <b>Zonas</b> (👁) oculta as zonas e <b>Auto-foco</b> escurece o mapa e ilumina só os elementos (PTs, players, objetivos, inimigos). <b>Ctrl+Z</b> desfaz a criação.</p></section>
<section class="guide-sec highlight"><h3>6 · Variações do cenário <span class="tagimp">pouco óbvio</span></h3><p>Botão <b>Variação</b> cria uma cópia do cenário pra uma mudança pequena, sem poluir a lista. Ficam agrupadas embaixo do cenário-base (<b>1 → 1a → 1b</b>).</p></section>
...
<section class="guide-sec"><h3>10 · Atalhos (PC)</h3><p class="guide-keys"><b>V</b> selecionar · <b>A</b> seta · <b>L</b> linha · <b>D</b> livre · <b>R</b> área · <b>I</b> ícone · <b>N</b> nota · <b>scroll</b> zoom · <b>Ctrl+Z/Y</b> desfazer/refazer · <b>Ctrl+C/V</b> copiar/colar · <b>Del</b> excluir o selecionado.</p></section>
...
<section class="guide-sec"><h3>1 · La idea — Fases y Escenarios</h3><p>Cada <b>escenario</b> es una "foto" del mapa (posiciones, dibujos, objetivos activos, vida). Armas una secuencia de fases (ej.: <i>Apertura → Medio → Boss</i>) y navegas por ellas en la barra de abajo (botón <b>Fases</b>). Presentar reproduce esa secuencia en pantalla completa.</p><p>En el editor de fases (abajo) puedes poner un <b>nombre</b>, una <b>condición</b> y el <b>tiempo de juego</b> de ese escenario (campo <b>⏱ 30m</b>) — aparece como sello en la barra y en la presentación, dejando claro que esa escena es a los 30m, la otra a los 25m, etc.</p><p>El botón de <b>diana</b> (📍) en los controles de zoom <b>guarda el zoom/encuadre</b> de esa escena — al volver a ella (incluso presentando), el mapa vuelve a ese zoom. Tócalo de nuevo para limpiar.</p></section>
<section class="guide-sec highlight"><h3>2 · Armar los equipos — subir el roster <span class="tagimp">poco obvio</span></h3><p>En <b>Roster → Editar roster</b> pegas la inscripción de Discord. Para obtener el JSON:</p><ol><li>Abre el <b>mensaje de inscripción del Board</b> en Discord.</li><li>En su <b>pie</b>, toca el enlace <b>"Web view"</b>.</li><li>En la página que abre, toca <b>"JSON"</b> en el <b>encabezado</b> del Board.</li><li>Selecciona todo con <b>Ctrl+A</b> y copia (<b>Ctrl+C</b>).</li><li>Pega en el campo <b>Formación del Discord</b> y toca <b>Procesar</b> o <b>Combinar</b>.</li></ol><ul><li><b>Procesar (reemplaza):</b> cambia todo el roster por lo que pegaste.</li><li><b>Combinar con actual:</b> mantiene a quien ya está armado (PT, etiquetas, flags), agrega a los nuevos como reserva y <b>quita</b> a quien no aparece en el nuevo JSON — ideal para actualizar la lista sin rehacer el board.</li><li>Reconoce automático: <i>Ranged/Melee → DPS</i>, <i>Absence → ausente</i>, <i>Bench/Tentative → reserva</i>. Luego usa <b>Auto-armar PTs</b> o arrastra en la pestaña <b>Board</b>.</li><li><b>Poner en el mapa:</b> arrastra una <b>PT</b> entera, o cambia a la pestaña <b>Players</b> y arrastra un jugador. El número en la bola de la PT muestra <b>cuántos siguen en la formación</b> — al destacar a alguien, ese número baja.</li></ul></section>
<section class="guide-sec highlight"><h3>3 · Gestos en el token del jugador <span class="tagimp">poco obvio</span></h3><ul><li><b>1 toque</b> = abre el menú (vida, muerto, vincular, bloquear, quitar).</li><li><b>Mantener (~0,4s)</b> = oculta/muestra el nombre (oculto, se vuelve un círculo con el nº de la PT).</li><li><b>Mantener 5s</b> = mueve el nombre al lado del ícono.</li><li><b>2 toques</b> = quita el token del mapa.</li></ul></section>
<section class="guide-sec highlight"><h3>4 · Vínculos (flechas) <span class="tagimp">poco obvio</span></h3><p>Abre el menú de un ícono y toca <b>Vincular</b> → toca <b>otro ícono</b> para crear la flecha. Queda armada en el origen, así puedes <b>encadenar</b> varias. <b>Toca la flecha</b> para quitarla. La fina es la unión PT↔miembro; las gruesas son estratégicas.</p></section>
<section class="guide-sec highlight"><h3>5 · Foco / spotlight <span class="tagimp">poco obvio</span></h3><p>Herramienta de <b>objetivo</b> en la barra izquierda: <b>arrastra</b> para destacar un área — el resto se oscurece. Puedes tener <b>varios focos</b>. En la herramienta <b>Seleccionar</b>, toca el <b>borde</b> de un foco para <b>arrastrarlo</b> (mover) y aparece la <b>✕</b> para quitarlo — el centro sigue siendo clicable para los tokens. Al seleccionar un foco: el <b>tirador</b> de arriba lo rota, el botón de <b>forma</b> alterna rectángulo/elipse y la <b>✕</b> lo quita, y los <b>tiradores de esquina</b> lo redimensionan. Botones en la barra: <b>Zonas</b> (👁) oculta las zonas y <b>Auto-foco</b> oscurece el mapa e ilumina solo los elementos (PTs, players, objetivos, enemigos). <b>Ctrl+Z</b> deshace la creación.</p></section>
<section class="guide-sec highlight"><h3>6 · Variaciones del escenario <span class="tagimp">poco obvio</span></h3><p>El botón <b>Variación</b> crea una copia del escenario para un cambio pequeño, sin ensuciar la lista. Quedan agrupadas bajo el escenario base (<b>1 → 1a → 1b</b>).</p></section>
...
<section class="guide-sec"><h3>10 · Atajos (PC)</h3><p class="guide-keys"><b>V</b> seleccionar · <b>A</b> flecha · <b>L</b> línea · <b>D</b> libre · <b>R</b> área · <b>I</b> ícono · <b>N</b> nota · <b>scroll</b> zoom · <b>Ctrl+Z/Y</b> deshacer/rehacer · <b>Ctrl+C/V</b> copiar/pegar · <b>Supr</b> eliminar lo seleccionado.</p></section>
...
<section class="guide-sec"><h3>1 · The idea — Phases &amp; Scenarios</h3><p>Each <b>scenario</b> is a "snapshot" of the map (positions, drawings, active objectives, HP). You build a sequence of phases (e.g. <i>Opening → Mid → Boss</i>) and step through them on the bottom rail (<b>Phases</b> button). Present plays that sequence full-screen.</p><p>In the phase editor (bottom) you can set a <b>name</b>, a <b>condition</b> and the <b>game time</b> for that scenario (the <b>⏱ 30m</b> field) — it shows as a badge on the rail and in Present, making it clear that this scene is at 30m, the next at 25m, and so on.</p><p>The <b>target</b> button (📍) in the zoom controls <b>saves the zoom/framing</b> for that scene — when you return to it (including while presenting), the map snaps back to that zoom. Tap again to clear.</p></section>
<section class="guide-sec highlight"><h3>2 · Building the teams — uploading the roster <span class="tagimp">not obvious</span></h3><p>In <b>Roster → Edit roster</b> you paste the Discord sign-up. To grab the sign-up JSON:</p><ol><li>Open the <b>Board sign-up message</b> on Discord.</li><li>In its <b>footer</b>, click the <b>"Web view"</b> link.</li><li>On the page that opens, click <b>"JSON"</b> in the Board <b>header</b>.</li><li>Select all with <b>Ctrl+A</b> and copy (<b>Ctrl+C</b>).</li><li>Paste into the <b>Discord sign-up</b> field and hit <b>Process</b> or <b>Merge</b>.</li></ol><ul><li><b>Process (replace):</b> swaps the whole roster for what you pasted.</li><li><b>Merge with current:</b> keeps whoever is already set up (PT, tags, flags), adds new players as reserve and <b>drops</b> whoever isn't in the new JSON — ideal for refreshing the list without rebuilding the board.</li><li>Auto-detects: <i>Ranged/Melee → DPS</i>, <i>Absence → absent</i>, <i>Bench/Tentative → reserve</i>. Then use <b>Auto-build PTs</b> or drag in the <b>Board</b> tab.</li><li><b>Place on the map:</b> drag a whole <b>PT</b> from the list, or switch to the <b>Players</b> tab and drag an individual player. The number on the PT ball shows <b>how many are still in formation</b> — placing someone drops that count.</li></ul></section>
<section class="guide-sec highlight"><h3>3 · Player token gestures <span class="tagimp">not obvious</span></h3><ul><li><b>1 tap</b> = opens the menu (HP, dead, link, lock, remove).</li><li><b>Hold (~0.4s)</b> = hide/show the name (hidden, it becomes a small dot with the PT number).</li><li><b>Hold 5s</b> = moves the name to the side of the icon.</li><li><b>2 taps</b> = removes the token from the map.</li></ul></section>
<section class="guide-sec highlight"><h3>4 · Links (arrows) <span class="tagimp">not obvious</span></h3><p>Open an icon's menu and hit <b>Link</b> → tap <b>another icon</b> to draw the arrow. It stays armed at the origin, so you can <b>chain</b> several. <b>Tap the arrow</b> to remove it. The thin one is the PT↔member tether; thick ones are strategic.</p></section>
<section class="guide-sec highlight"><h3>5 · Focus / spotlight <span class="tagimp">not obvious</span></h3><p><b>Target</b> tool on the left bar: <b>drag</b> to highlight an area — the rest dims. You can have <b>multiple focuses</b>. With the <b>Select</b> tool, touch a focus's <b>border</b> to <b>drag</b> it (move) and reveal the <b>✕</b> to remove it — the middle stays clickable for tokens. When a focus is selected: the top <b>handle</b> rotates it, the <b>shape</b> button toggles rectangle/ellipse and <b>✕</b> removes it, and the <b>corner handles</b> resize it. Toolbar buttons: <b>Zones</b> (👁) hides the areas and <b>Auto-focus</b> darkens the map and lights only the elements (PTs, players, objectives, enemies). <b>Ctrl+Z</b> undoes creation.</p></section>
<section class="guide-sec highlight"><h3>6 · Scenario variations <span class="tagimp">not obvious</span></h3><p>The <b>Variation</b> button clones the current scenario for a small change, without cluttering the list. They're grouped under the base scenario (<b>1 → 1a → 1b</b>).</p></section>
...
<section class="guide-sec"><h3>10 · Shortcuts (PC)</h3><p class="guide-keys"><b>V</b> select · <b>A</b> arrow · <b>L</b> line · <b>D</b> freehand · <b>R</b> area · <b>I</b> icon · <b>N</b> note · <b>scroll</b> zoom · <b>Ctrl+Z/Y</b> undo/redo · <b>Ctrl+C/V</b> copy/paste · <b>Del</b> delete the selected one.</p></section>
<section class="guide-sec tips"><h3>Tips</h3><ul><li>Build the base in <b>scenario 1</b> and use <b>Duplicate</b> for the next phase.</li><li>Hide names on players that don't need highlighting.</li><li>Use <b>Focus</b> + <b>Present</b> to guide the call.</li></ul></section>` }
  ...
  function init() {
    ...
    try { if (localStorage.getItem('gp-tools-mini') === '1') drawTools.classList.add('mini'); if (localStorage.getItem('gp-side-min') === '1' && !isMobile()) { document.body.classList.add('side-min'); const sm = $('sideMin'); if (sm) sm.textContent = '«'; } if (localStorage.getItem('gp-canvas-fill') === '1') { canvasFill = true; const fb = $('fillTgl'); if (fb) fb.classList.add('on'); } if (localStorage.getItem('gp-hud') === '0') { const sh = $('sceneHud'); if (sh) sh.style.display = 'none'; } } catch (e) {}
    renderSidebar(); renderRail(); loadScenarioIntoUI(); fit(); applySceneView(cur()); updateZoomSaveBtn(); wireEvents(); maybeLoadShared(); maybeLoadBoard(); maybeLoadPlan();
  ...
  function toggleCanvasFill() { canvasFill = !canvasFill; try { localStorage.setItem('gp-canvas-fill', canvasFill ? '1' : '0'); } catch (e) {} const b = $('fillTgl'); if (b) b.classList.toggle('on', canvasFill); fit(); applySceneView(cur()); }
  ...
  function renderPlayerChips() {
    ...
    players.forEach(p => {
      ...
      chip.addEventListener('click', () => { if (isMobile() && p.pt) { const s = stage.scaleX() || 1; detachMember(p.pt, p.nome, p.funcao, clamp01(((VW / 2) - stage.x()) / s / W), clamp01(((VH / 2) - stage.y()) / s / H)); document.body.classList.remove('mob-roster'); toast(p.nome + ' ✓'); } });
      ptList.appendChild(chip);
    });
  }
  ...
  function cleanupReplaces(list) { const names = new Set(list.map(p => p.nome)); let n = 0; list.forEach(p => { if (p.replaceOf && !names.has(p.replaceOf)) { delete p.replaceOf; p.replace = false; n++; } }); return n; }
  ...
  function renderObjPanel() {
    ...
    // toggles rápidos POR LADO: liga/desliga tudo do lado Azul (_o / Oeste) ou
    // Vermelho (_l / Leste) de uma vez
    const sideOf = id => /_o$/.test(id) ? 'o' : (/_l$/.test(id) ? 'l' : null);
    const sideToggle = (side, scope) => { const list = (scope || CFG.objetivos).filter(o => sideOf(o.id) === side); if (!list.length) return; const all = list.every(o => up[o.id]); pushUndo(); list.forEach(o => setObjUp(o.id, !all)); renderObjectives(); renderObjPanel(); saveProject(); };
    const srow = document.createElement('div'); srow.className = 'obj-siderow';
    const mkSideBtn = (side, label, scope, mini) => { const list = (scope || CFG.objetivos).filter(o => sideOf(o.id) === side); const n = list.filter(o => up[o.id]).length; const b = document.createElement('button'); b.type = 'button'; b.className = 'obj-side ' + (side === 'o' ? 'blue' : 'red') + (n === list.length && list.length ? ' on' : '') + (mini ? ' mini' : ''); b.innerHTML = '<span class="sc-dot"></span>' + label + (mini ? '' : ' <span class="gcount">' + n + '/' + list.length + '</span>'); b.addEventListener('click', e => { e.stopPropagation(); sideToggle(side, scope); }); return b; };
    ...
    CFG.objetivosGrupos.forEach(grp => {
      ...
      // grupos com os 2 lados (Torres/Ganso/Árvore) ganham mini-botões O/L no cabeçalho
      if (list.some(o => sideOf(o.id) === 'o') && list.some(o => sideOf(o.id) === 'l')) { const wrap = document.createElement('span'); wrap.className = 'gh-sides'; wrap.appendChild(mkSideBtn('o', '', list, true)); wrap.appendChild(mkSideBtn('l', '', list, true)); gh.insertBefore(wrap, gh.querySelector('.gcount')); }
  ...
  function renderFocus(previewRect) {
    ...
    if (!editable) { validManual.forEach(f => { const c = focusCenter(f); const g = new Konva.Group({ x: c.cx, y: c.cy, rotation: f.rot || 0 }); holeInto(g, f); focusLayer.add(g); }); }
      ...
      [delB, shpB, rotHit].forEach(n => { n.on('mouseenter', () => { stage.container().style.cursor = 'pointer'; showUI(); }); n.on('mouseleave', hideUI); });
      corners.forEach(h => { h.on('mouseenter', () => { stage.container().style.cursor = 'nwse-resize'; showUI(); }); h.on('mouseleave', hideUI); h.on('mousedown touchstart', e => { e.cancelBubble = true; focusResizeDrag = { idx: idx }; pushUndo(); }); });
      frame.on('mouseenter', () => { stage.container().style.cursor = 'move'; showUI(); });
      frame.on('mouseleave', () => { stage.container().style.cursor = toolCursor(); hideUI(); });
  ...
  function selectScenario(id) { if (id === state.currentId) return; if (linkTempFrom) cancelLink(); closeIconMenu(); hidePopover(); state.currentId = id; renderRail(); loadScenarioIntoUI(); renderDrawings(); renderMarks(); renderObjectives(); renderTokens(); renderFocus(); renderSidebar(); updateMini(); if (!objPanel.hidden) renderObjPanel(); if (state.present) updatePresentUI(); applySceneView(cur()); updateZoomSaveBtn(); saveProject(); }
  function loadScenarioIntoUI() { const s = cur(); if (!s) return; nameInput.value = s.nome || ''; if (timeInput) timeInput.value = s.tempo || ''; condInput.value = s.condicao || ''; noteInput.value = s.nota || ''; updateMini(); }
  ...
  async function closeRoster(force) {
    if (force !== true && !rosterModal.hidden && rosterDirty()) { if (await askConfirm(t('confirmSaveBoard'))) applyRosterDraft(); }
  ...
  function applyImported(d) { const scenarios = Array.isArray(d.cenarios) ? d.cenarios : (Array.isArray(d.scenarios) ? d.scenarios : null); if (!scenarios || !scenarios.length) { alert(t('noScenes')); return false; } state.scenarios = scenarios.map(sanitizeScenario); state.roster = Array.isArray(d.roster) ? d.roster.map(sanitizePlayer) : []; cleanupReplaces(state.roster); state.objetivoPosGlobal = sanitizePosMap(d.objetivoPosGlobal); state.gates = sanitizePosMap(d.gates); state.side = (d.side === 'blue' || d.side === 'red') ? d.side : null; state.ptDesc = sanitizeDesc(d.ptDesc); state.ptIcon = sanitizeDesc(d.ptIcon); if (typeof d.showNames === 'boolean') state.showNames = d.showNames; state.currentId = d.currentId && state.scenarios.some(s => s.id === d.currentId) ? d.currentId : state.scenarios[0].id; hidePopover(); renderRail(); loadScenarioIntoUI(); renderDrawings(); renderObjectives(); renderSidebar(); renderTokens(); saveProject(); return true; }
  function importProjectFile(file) { const reader = new FileReader(); reader.onload = async () => { let d; try { d = JSON.parse(reader.result); } catch (e) { toast(t('invalidJson')); return; } if (!Array.isArray(d.cenarios) && !Array.isArray(d.scenarios)) { toast(t('noScenesFile')); return; } if (state.scenarios.some(s => !isPristine(s)) && !await askConfirm(t('confirmImport'))) return; applyImported(d); }; reader.readAsText(file); }
  ...
  async function maybeLoadShared() { const m = /[#&]p=([^&]+)/.exec(location.hash); if (!m) return; let d; try { d = await decodeShare(decodeURIComponent(m[1])); } catch (e) { toast(t('linkInvalid')); return; } if (state.scenarios.some(s => !isPristine(s)) && !await askConfirm(t('confirmShared'))) return; if (applyImported(d)) toast(t('planLoadedLink')); }
  ...
  async function loadPlan(slug) {
    ...
    if (state.scenarios.some(s => !isPristine(s)) && !await askConfirm(t('confirmOpenPlan'))) return;
    if (applyImported(d)) toast(t('planLoaded'));
  }
  ...
  function wireEvents() {
    ...
    { const hb = $('helpBtn'), hm = $('helpModal'), hc = $('helpClose'); if (hb && hm) { hb.addEventListener('click', () => { fillGuide(); hm.hidden = false; }); if (hc) hc.addEventListener('click', () => { hm.hidden = true; }); hm.addEventListener('click', e => { if (e.target === hm) hm.hidden = true; }); document.addEventListener('keydown', e => { if (e.key === 'Escape' && !hm.hidden) hm.hidden = true; }); } }
    ...
    parseBtn.addEventListener('click', () => { const parsed = parseRoster(rosterPaste.value); if (!parsed.length) { parseMsg.className = 'parse-msg err'; parseMsg.textContent = t('rosterNone'); return; } rosterDraft = parsed; parseMsg.className = 'parse-msg ok'; parseMsg.textContent = parsed.length + ' ' + t('rosterOk'); renderGrid(); });
    if (mergeBtn) mergeBtn.addEventListener('click', () => { const parsed = parseRoster(rosterPaste.value); if (!parsed.length) { parseMsg.className = 'parse-msg err'; parseMsg.textContent = t('rosterNone'); return; } const r = mergeRoster(parsed); parseMsg.className = 'parse-msg ok'; parseMsg.textContent = r.kept + ' ' + t('mKept') + ' · ' + r.added + ' ' + t('mAdded') + ' · ' + r.removed + ' ' + t('mRemoved'); renderGrid(); });
    ...
    bdPop.addEventListener('click', e => {
      ...
      const pt = e.target.closest('.bp-p'), r = e.target.closest('.bp-r'), ro = e.target.closest('.bp-ro'), tg = e.target.closest('.bp-t'), f = e.target.closest('.bp-f');
    ...
    rosterClear2.addEventListener('click', async () => { if (await askConfirm(t('confirmClearPlayers'))) { rosterDraft = []; renderGrid(); } });
    // editor de PT
    ...
    rosterSave.addEventListener('click', () => { const moved = applyRosterDraft(); saveMsg.className = 'parse-msg ok'; saveMsg.textContent = 'Roster salvo ✓' + (moved ? ' · ' + moved + ' posição(ões) herdada(s)' : ''); setTimeout(() => closeRoster(true), 500); });
