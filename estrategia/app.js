  ...
  function wireEvents() {
    ...
    { const lb = $('liveBtn'), lm = $('liveModal');
      if (lb && lm) {
        ...
        window.addEventListener('resize', placeLiveBar);
      } }
