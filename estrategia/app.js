...
<section class="guide-sec highlight"><h3>5 · Foco / spotlight <span class="tagimp">recurso novo</span></h3><p>Ferramenta de <b>alvo</b> na barra esquerda: <b>arraste</b> pra destacar uma área — o resto escurece. <b>Clique curto</b> sobre o foco pra limpar.</p></section>
<section class="guide-sec highlight"><h3>6 · Variações do cenário <span class="tagimp">recurso novo</span></h3><p>Botão <b>Variação</b> cria uma cópia do cenário pra uma mudança pequena, sem poluir a lista. Ficam agrupadas embaixo do cenário-base (<b>1 → 1a → 1b</b>).</p></section>
...
<section class="guide-sec highlight"><h3>5 · Foco / spotlight <span class="tagimp">nuevo</span></h3><p>Herramienta de <b>objetivo</b> en la barra izquierda: <b>arrastra</b> para destacar un área — el resto se oscurece. <b>Toque corto</b> sobre el foco para limpiar.</p></section>
<section class="guide-sec highlight"><h3>6 · Variaciones del escenario <span class="tagimp">nuevo</span></h3><p>El botón <b>Variación</b> crea una copia del escenario para un cambio pequeño, sin ensuciar la lista. Quedan agrupadas bajo el escenario base (<b>1 → 1a → 1b</b>).</p></section>
...
<section class="guide-sec highlight"><h3>5 · Focus / spotlight <span class="tagimp">new</span></h3><p><b>Target</b> tool on the left bar: <b>drag</b> to highlight an area — the rest dims. <b>Short tap</b> on the focus to clear it.</p></section>
<section class="guide-sec highlight"><h3>6 · Scenario variations <span class="tagimp">new</span></h3><p>The <b>Variation</b> button clones the current scenario for a small change, without cluttering the list. They're grouped under the base scenario (<b>1 → 1a → 1b</b>).</p></section>
