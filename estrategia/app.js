  ...
  function openGrade() {
    ...
    if (body && !body.dataset.wired) {
      ...
      body.addEventListener('click', e => {
        const c = e.target.closest('.g-obs-c'); if (!c) return;
