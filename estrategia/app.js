...
<section class="guide-sec highlight"><h3>2 · Subir o roster <span class="tagimp">pouco óbvio</span></h3><p>Em <b>Roster</b>, cole a inscrição do Discord:</p><ol><li>Abra a <b>mensagem de inscrição do Board</b> no Discord.</li><li>No rodapé, clique em <b>"Web view"</b>.</li><li>Clique em <b>"JSON"</b> no cabeçalho do Board.</li><li><b>Ctrl+A</b> e copie.</li><li>Cole no campo e use <b>Processar</b> (substitui tudo) ou <b>Mesclar</b> (mantém quem já está montado, adiciona novos como reserva, remove quem saiu — e <b>herda as posições no mapa</b>).</li></ol></section>
...
<section class="guide-sec"><h3>10 · Salvar, compartilhar e planos</h3><ul><li>Salva sozinho no navegador. <b>Exportar/Importar</b> JSON.</li><li><b>Compartilhar</b> = link com o plano inteiro. <b>?plan=nome</b> abre planos fixos da guild. <b>🔗 Copiar</b> (no Board) = link só da composição.</li></ul></section>
...
<section class="guide-sec"><h3>10 · Guardar, compartir y planes</h3><ul><li>Guarda solo en el navegador. <b>Exportar/Importar</b> JSON.</li><li><b>Compartir</b> = enlace con todo el plan. <b>?plan=nombre</b> abre planes fijos. <b>🔗 Copiar</b> (Board) = enlace solo de la composición.</li></ul></section>
...
<section class="guide-sec"><h3>10 · Save, share, plans</h3><ul><li>Auto-saves in the browser. <b>Export/Import</b> JSON.</li><li><b>Share</b> = full-plan link. <b>?plan=name</b> opens fixed plans. <b>🔗 Copy</b> (Board) = composition-only link.</li></ul></section>
