...
(function () {
  ...
  const I18N = {
    pt: {
      ...
      // --- i18n v2: textos que estavam fixos no app/index/config ---
      sceneNewName:'Novo cenário', sceneDelOne:'Excluir o cenário "%s"?', sceneDelKids:'Excluir "%s" e suas %n variação(ões)?', faseLbl:'Fase', sceneNoNote:'Sem nota neste cenário.', sceneAria:'Cena',
      poNoMembers:'Sem membros. Defina no roster.', poResTag:'reserva', poDragHint:'Arraste um membro para fora → ele sai ligado à PT por um traço.', editShort:'editar', delLbl:'Excluir',
      noteSmall:'Menor', noteBig:'Maior', noteColorTip:'Cor da nota (usa a cor selecionada na barra)', absentOne:'ausente',
      peNoMembers:'Sem membros nesta PT. Adicione abaixo.', peRemoveTip:'Tirar da PT', peNoAvail:'— ninguém disponível —', ptIconNone:'sem', membersLbl:'Membros', addPlus:'+ Adicionar',
      ptDescLbl:'Descrição / objetivo da PT', ptDescPh:'ex: Siege Damage · Torre Top · Segura árvore…', ptIconLbl:'Ícone da PT', peHint:'Editar aqui muda o roster. Arraste a PT pro mapa normalmente.',
      mobPresent:'Modo apresentação.', mobEditDesktop:'A edição é feita no desktop.', prevScene:'Cenário anterior', nextScene:'Próximo cenário', prevLbl:'Anterior', nextLbl:'Próximo',
      expandMap:'Expandir mapa', saveZoomScene:'Salvar zoom da cena', confirmAsk:'Tem certeza?',
      cfg_torres:'Torres', cfg_ganso:'Ganso', cfg_arvore:'Árvore', cfg_posnirvana:'Pós-Nirvana', cfg_colapso:'Colapso', cfg_colapso_arv:'Colapso de Árvores', cfg_se_levamos:'se levamos', cfg_se_nao_levamos:'se não levamos', cfg_vitoria:'vitória', cfg_derrota:'derrota',
      objLbl_torre_top_o:'Torre Top (O)', objLbl_torre_mid_o:'Torre Mid (O)', objLbl_torre_bot_o:'Torre Bot (O)', objLbl_torre_top_l:'Torre Top (L)', objLbl_torre_mid_l:'Torre Mid (L)', objLbl_torre_bot_l:'Torre Bot (L)', objLbl_ganso_o:'Ganso (Oeste)', objLbl_ganso_l:'Ganso (Leste)', objLbl_arvore_o:'Árvore (Oeste)', objLbl_arvore_l:'Árvore (Leste)',
      objInfo_jungle:'💰 780 fun coins ao matar.', objInfo_tower:'💰 Gera 200 fun coins a cada 30s enquanto viva.', objInfo_goose:'🔓 Libera após cair 1 torre. Dá muito dano — cada torre levada reduz o dano e a resistência dele.', objInfo_tree:'🔓 Libera após o Ganso morrer.',
      closeLbl:'Fechar', zoomInLbl:'Aproximar', zoomOutLbl:'Afastar', zoomFitLbl:'Ajustar'
    },
    es: {
      ...
      sceneNewName:'Nueva escena', sceneDelOne:'¿Eliminar la escena "%s"?', sceneDelKids:'¿Eliminar "%s" y sus %n variación(es)?', faseLbl:'Fase', sceneNoNote:'Sin nota en esta escena.', sceneAria:'Escena',
      poNoMembers:'Sin miembros. Defínelos en el roster.', poResTag:'reserva', poDragHint:'Arrastra un miembro hacia afuera → sale vinculado a la PT por una línea.', editShort:'editar', delLbl:'Eliminar',
      noteSmall:'Menor', noteBig:'Mayor', noteColorTip:'Color de la nota (usa el color seleccionado en la barra)', absentOne:'ausente',
      peNoMembers:'Sin miembros en esta PT. Añade abajo.', peRemoveTip:'Quitar de la PT', peNoAvail:'— nadie disponible —', ptIconNone:'sin', membersLbl:'Miembros', addPlus:'+ Añadir',
      ptDescLbl:'Descripción / objetivo de la PT', ptDescPh:'ej.: Siege Damage · Torre Top · Sostén el árbol…', ptIconLbl:'Ícono de la PT', peHint:'Editar aquí cambia el roster. Arrastra la PT al mapa normalmente.',
      mobPresent:'Modo presentación.', mobEditDesktop:'La edición se hace en el escritorio.', prevScene:'Escena anterior', nextScene:'Escena siguiente', prevLbl:'Anterior', nextLbl:'Siguiente',
      expandMap:'Expandir mapa', saveZoomScene:'Guardar zoom de la escena', confirmAsk:'¿Seguro?',
      cfg_torres:'Torres', cfg_ganso:'Ganso', cfg_arvore:'Árbol', cfg_posnirvana:'Pos-Nirvana', cfg_colapso:'Colapso', cfg_colapso_arv:'Colapso de árboles', cfg_se_levamos:'si las tomamos', cfg_se_nao_levamos:'si no las tomamos', cfg_vitoria:'victoria', cfg_derrota:'derrota',
      objLbl_torre_top_o:'Torre Top (O)', objLbl_torre_mid_o:'Torre Mid (O)', objLbl_torre_bot_o:'Torre Bot (O)', objLbl_torre_top_l:'Torre Top (E)', objLbl_torre_mid_l:'Torre Mid (E)', objLbl_torre_bot_l:'Torre Bot (E)', objLbl_ganso_o:'Ganso (Oeste)', objLbl_ganso_l:'Ganso (Este)', objLbl_arvore_o:'Árbol (Oeste)', objLbl_arvore_l:'Árbol (Este)',
      objInfo_jungle:'💰 780 fun coins al matarlo.', objInfo_tower:'💰 Genera 200 fun coins cada 30s mientras vive.', objInfo_goose:'🔓 Se libera al caer 1 torre. Hace mucho daño: cada torre caída reduce su daño y su resistencia.', objInfo_tree:'🔓 Se libera cuando muere el Ganso.',
      closeLbl:'Cerrar', zoomInLbl:'Acercar', zoomOutLbl:'Alejar', zoomFitLbl:'Ajustar'
    },
    en: {
      ...
      sceneNewName:'New scene', sceneDelOne:'Delete the scene "%s"?', sceneDelKids:'Delete "%s" and its %n variation(s)?', faseLbl:'Phase', sceneNoNote:'No note in this scene.', sceneAria:'Scene',
      poNoMembers:'No members. Set them in the roster.', poResTag:'reserve', poDragHint:'Drag a member out → it leaves linked to the PT by a line.', editShort:'edit', delLbl:'Delete',
      noteSmall:'Smaller', noteBig:'Bigger', noteColorTip:'Note color (uses the color selected in the bar)', absentOne:'absent',
      peNoMembers:'No members in this PT. Add below.', peRemoveTip:'Remove from PT', peNoAvail:'— no one available —', ptIconNone:'none', membersLbl:'Members', addPlus:'+ Add',
      ptDescLbl:'PT description / objective', ptDescPh:'e.g.: Siege Damage · Turret Top · Hold the tree…', ptIconLbl:'PT icon', peHint:'Editing here changes the roster. Drag the PT onto the map as usual.',
      mobPresent:'Presentation mode.', mobEditDesktop:'Editing is done on desktop.', prevScene:'Previous scene', nextScene:'Next scene', prevLbl:'Previous', nextLbl:'Next',
      expandMap:'Expand map', saveZoomScene:'Save scene zoom', confirmAsk:'Are you sure?',
      cfg_torres:'Turrets', cfg_ganso:'Goose', cfg_arvore:'Tree', cfg_posnirvana:'Post-Nirvana', cfg_colapso:'Collapse', cfg_colapso_arv:'Tree collapse', cfg_se_levamos:'if we take them', cfg_se_nao_levamos:'if we don\'t take them', cfg_vitoria:'victory', cfg_derrota:'defeat',
      objLbl_torre_top_o:'Turret Top (W)', objLbl_torre_mid_o:'Turret Mid (W)', objLbl_torre_bot_o:'Turret Bot (W)', objLbl_torre_top_l:'Turret Top (E)', objLbl_torre_mid_l:'Turret Mid (E)', objLbl_torre_bot_l:'Turret Bot (E)', objLbl_ganso_o:'Goose (West)', objLbl_ganso_l:'Goose (East)', objLbl_arvore_o:'Tree (West)', objLbl_arvore_l:'Tree (East)',
      objInfo_jungle:'💰 780 fun coins on kill.', objInfo_tower:'💰 Generates 200 fun coins every 30s while alive.', objInfo_goose:'🔓 Unlocks after 1 turret falls. Hits hard — each turret taken reduces its damage and resistance.', objInfo_tree:'🔓 Unlocks after the Goose dies.',
      closeLbl:'Close', zoomInLbl:'Zoom in', zoomOutLbl:'Zoom out', zoomFitLbl:'Fit'
    }
  };
  ...
  // ---- tradução de textos que vêm do config.js (window.WWM) ----
  // O config guarda as strings em PT e não conhece t(); o mapa abaixo troca as
  // que mudam de idioma, com fallback pro próprio texto do config.
  const CFG_TXT = { 'Torres': 'cfg_torres', 'Ganso': 'cfg_ganso', 'Árvore': 'cfg_arvore', 'Pós-Nirvana': 'cfg_posnirvana', 'Colapso': 'cfg_colapso', 'Colapso de Árvores': 'cfg_colapso_arv', 'se levamos': 'cfg_se_levamos', 'se não levamos': 'cfg_se_nao_levamos', 'vitória': 'cfg_vitoria', 'derrota': 'cfg_derrota', 'Cenário': 'sceneBtn', 'Novo cenário': 'sceneNewName' };
  function cfgTxt(s) { const k = CFG_TXT[s]; return k ? t(k) : s; }
  // nome de guerra padrão ("Guerra 2" gravado em qualquer idioma) exibido no idioma atual
  function warNome(n) { const m = /^(Guerra|War) (\d+)$/.exec(n || ''); return m ? t('warDefault') + ' ' + m[2] : (n || ''); }
  const OBJ_LBL = { torre_top_o: 'objLbl_torre_top_o', torre_mid_o: 'objLbl_torre_mid_o', torre_bot_o: 'objLbl_torre_bot_o', torre_top_l: 'objLbl_torre_top_l', torre_mid_l: 'objLbl_torre_mid_l', torre_bot_l: 'objLbl_torre_bot_l', ganso_o: 'objLbl_ganso_o', ganso_l: 'objLbl_ganso_l', arvore_o: 'objLbl_arvore_o', arvore_l: 'objLbl_arvore_l' };
  function objRotulo(o) { const k = o && OBJ_LBL[o.id]; return k ? t(k) : ((o && o.rotulo) || (o && o.id) || ''); }
  const OBJ_INFO = { jungle: 'objInfo_jungle', tower: 'objInfo_tower', goose: 'objInfo_goose', tree: 'objInfo_tree' };
  ...
  const state = { scenarios: [], currentId: null, roster: [], ptDesc: {}, ptIcon: {}, objetivoPosGlobal: {}, gates: {}, side: null, rhEvent: '', rhEvent2: '', jogos: [], jogoAtual: null, tool: 'select', drawColor: CFG.drawColors[0], drawWidth: CFG.drawWidths[0], present: false, showNames: true };
  ...
  // ---- temas (board, grade e imagem) ----
  // O tema é escolha de cada officer e fica no navegador (não viaja no link do board).
  // 'planilha' troca também as cores de função para as da planilha da staff.
  const TEMAS = ['escuro', 'contraste', 'claro', 'planilha'];
  const TEMA_KEY = 'zhi_tema_v1';
  let temaAtual = 'escuro'; try { const tv = localStorage.getItem(TEMA_KEY); if (TEMAS.indexOf(tv) >= 0) temaAtual = tv; } catch (e) {}
  const ROLE_PLANILHA = { Tank: '#E69138', DPS: '#6FA8DC', Healer: '#93C47D' };
  function aplicarTema() { if (temaAtual === 'escuro') delete document.documentElement.dataset.tema; else document.documentElement.dataset.tema = temaAtual; }
  aplicarTema();
  // Troca de tema num lugar só: seletor do Board/Grade e amostras do aviso de entrada.
  function setTema(x) {
    temaAtual = TEMAS.indexOf(x) >= 0 ? x : 'escuro';
    try { localStorage.setItem(TEMA_KEY, temaAtual); } catch (e) {}
    aplicarTema();
    document.querySelectorAll('.tema-sel').forEach(o => { o.value = temaAtual; });
    try { if (rosterModal && !rosterModal.hidden) refreshRoster(); renderSidebar(); renderTokens(); const gm = $('gradeModal'); if (gm && !gm.hidden) renderGrade(); } catch (e) {}
  }
  function temaSelFill() { document.querySelectorAll('.tema-sel').forEach(sel => { sel.innerHTML = TEMAS.map(x => '<option value="' + x + '">🎨 ' + esc(t('tema_' + x)) + '</option>').join(''); sel.value = temaAtual; }); }
  // amostra de cor de cada tema (fundo, painel, destaque), no formato das bandeiras de idioma
  const TEMA_SW = { escuro: ['#0a0c11', '#12151d', '#D9A441'], contraste: ['#0d0f13', '#1e222b', '#ffffff'], claro: ['#f3f1ec', '#fbfaf7', '#a8741a'], planilha: ['#ffffff', '#E69138', '#6FA8DC', '#93C47D'] };
  function temaPillsHTML() {
    return '<div class="lg-pills tm-pills" role="group" aria-label="' + esc(t('temaLbl')) + '">' + TEMAS.map(x => {
      const c = TEMA_SW[x], nm = esc(t('tema_' + x));
      const sw = c.length > 3 ? '<rect width="22" height="15" fill="' + c[0] + '"/><rect x="2" y="4" width="6" height="7" fill="' + c[1] + '"/><rect x="8" y="4" width="6" height="7" fill="' + c[2] + '"/><rect x="14" y="4" width="6" height="7" fill="' + c[3] + '"/>'
        : '<rect width="22" height="15" fill="' + c[0] + '"/><rect x="3" y="3" width="16" height="9" rx="1.5" fill="' + c[1] + '"/><rect x="5" y="6" width="9" height="3" fill="' + c[2] + '"/>';
      return '<button type="button" class="lg-pill tm-pill' + (x === temaAtual ? ' on' : '') + '" data-tm="' + x + '" aria-label="' + nm + '" title="' + nm + '"><svg viewBox="0 0 22 15" aria-hidden="true">' + sw + '</svg></button>';
    }).join('') + '</div>';
  }
  function roleColor(f) { if (temaAtual === 'planilha') return ROLE_PLANILHA[f] || ROLE_PLANILHA.DPS; return CFG.roleColors[f] || CFG.roleColors.DPS; }
  // Paleta da imagem da Grade por tema: a imagem segue o tema escolhido.
  function imgPal() {
    const tc = { top: '#7fc6ff', mid: '#ffd166', bot: '#ff8fa3' };
    if (temaAtual === 'planilha') return { bg: '#ffffff', head: '#434343', head2: '#efefef', gold: '#ffe600', text: '#15181f', cellText: '#10131a', muted: '#6b7280', muted2: '#4b5563', dim: '#9ca3af', grid: 'rgba(0,0,0,.18)', novo: 'rgba(255,230,0,.35)', fill: true, tc: { top: '#1d4ed8', mid: '#a16207', bot: '#be123c' } };
    if (temaAtual === 'claro') return { bg: '#fbfaf7', head: '#efe9dc', head2: '#f4f0e6', gold: '#a8741a', text: '#1d1b17', muted: '#7a7366', muted2: '#6d675c', dim: '#b6ae9f', grid: 'rgba(40,36,28,.10)', novo: 'rgba(240,198,107,.28)', tc: { top: '#1d6fb8', mid: '#a36b00', bot: '#c0344d' } };
    if (temaAtual === 'contraste') return { bg: '#0d0f13', head: '#1e222b', head2: '#171a21', gold: '#ffc94d', text: '#ffffff', muted: '#b3bac8', muted2: '#c6ccd8', dim: '#6b7385', grid: 'rgba(255,255,255,.12)', novo: 'rgba(255,201,77,.22)', tc };
    return { bg: '#0b0e14', head: '#161a23', head2: '#11151d', gold: '#d9a441', text: '#e8ecf4', muted: '#5a6274', muted2: '#8b93a7', dim: '#3d434f', grid: 'rgba(255,255,255,.05)', novo: 'rgba(217,164,65,.14)', tc };
  }
  // ---- JG (jungle) por cor ----
  // As jungles do mapa têm 4 cores (as recuadas e as avançadas repetem as cores); o player
  // é ligado a uma COR e isso vale para a guerra inteira (os dois dias, todos os jogos).
  const JG_CORES = [ { id: 'vermelha', c: '#e0453a' }, { id: 'branca', c: '#f2f2f2' }, { id: 'amarela', c: '#f4c542' }, { id: 'verde', c: '#4fbf6a' } ];
  function jgCor(id) { return JG_CORES.find(x => x.id === id) || null; }
  function jgBadge(p) { const c = jgCor(p.jg); return c ? '<span class="c-jg" style="--jg:' + c.c + '" title="' + esc(t('jgLbl') + ' ' + t('jg_' + c.id)) + '"><img src="../assets/icons/funcoin.png" alt=""></span>' : ''; }
  function jgLinhas() { return JG_CORES.map(c => ({ cor: c.c, rotulo: t('jgLbl') + ' ' + t('jg_' + c.id) + ':', nomes: ((rosterModal && !rosterModal.hidden) ? rosterDraft : state.roster).filter(p => p.jg === c.id).map(p => nomeExib(p, 16)) })).filter(l => l.nomes.length); }
...
<section class="guide-sec highlight"><h3>3 · Board (montagem das PTs) <span class="tagimp">pouco óbvio</span></h3><ul><li>Com roster salvo, o modal <b>abre direto no Board</b>. Arraste players pras PTs, reservas da PT ou reservas gerais. As colunas rolam separadas.</li><li>Ferramentas na lateral: <b>⚙ Preencher</b> (auto-montar), <b>🧹 Esvaziar</b>, <b>🗂 Classe</b> (agrupa/colapsa por classe), <b>🔗 Copiar</b> (link só do board, sem cenários — quem abre aplica por cima do plano mantendo o mapa).</li><li><b>Replace com alvo:</b> clique num reserva → "⇄ Replace de" lista os titulares da PRÓPRIA PT. O selo aparece nos dois lados (no reserva e, tracejado, no titular).</li><li><b>↔ Outros jogos:</b> com vários jogos na guerra, o popover do player (e o <b>↔</b> no cabeçalho da PT) leva a posição — PT, reserva, função e torre — para os jogos marcados. Ctrl+Z desfaz.</li><li><b>Sábado e domingo juntos:</b> cole o link do evento de sábado e o de domingo no Roster. O roster junta as duas inscrições, a barra de jogos vira <b>Sáb G1…G5 | Dom G1…G5</b> e o board de cada dia mostra quem se inscreveu nele (quem só vai no outro dia fica apagado em "Inscritos só no outro dia", arrastável). O <b>⇉</b> replica o G1 do dia nos jogos vazios, o Dom G1 nasce como cópia do Sáb G1 sem quem não vai no domingo, e a Grade tem um seletor Sáb/Dom (uma imagem por dia). A nota do raid-helper aparece como 📝 no card e no popover.</li><li><b>⭐ Main roster:</b> no popover do player, "Marcar como main roster". Vale para toda guerra deste navegador (pelo userId do Discord): o ⚙ Preencher coloca essas pessoas primeiro e elas aparecem no topo de Disponíveis. O 📌 continua sendo a PT fixa de cada um. Com vários jogos, cada card mostra <b>N/5</b>, quantos jogos do dia a pessoa joga; <b>⛶ Telão</b> esconde as ferramentas e aumenta os nomes para a call dos officers.</li><li><b>🎨 Tema:</b> Escuro, Escuro contraste, Claro ou Planilha (cores da planilha da staff: laranja Tank, azul DPS, verde Healer). Vale para o board, a Grade e a 🖼 Imagem, e fica salvo neste navegador. <b>JG:</b> no popover do player, escolha a jungle dele (Vermelha, Branca, Amarela ou Verde; recuadas e avançadas têm as mesmas cores). Vale para a guerra toda, aparece como moeda colorida no card e numa linha por cor embaixo da Grade e da imagem.</li><li><b>☁ Salvar link:</b> salva o board com um nome curto e uma senha e gera <b>?s=nome</b>. Qualquer um com o link abre; para regravar precisa da senha criada no primeiro salvamento. F5 no link pega a versão mais nova.</li><li><b>⤓ Puxar players de outro board:</b> cole o link de um board antigo (🔗 Copiar) ou de um evento. Quem não está no roster entra na faixa "Puxados de outro board", com selo ⤓, para você arrastar e simular. O ⚙ Preencher ignora essas pessoas e o ✕ limpar tira quem não foi escalado em nenhum jogo.</li><li><b>Troca em 1 clique:</b> no selo ⇄ (aba Players) ou no menu do titular no mapa — o reserva assume a vaga e a POSIÇÃO em todas as cenas; clicar de novo desfaz.</li><li><b>Tour do Board:</b> o botão <b>🎓</b> (ao lado de 🔗 Copiar) abre um tour guiado dentro do próprio Board: jogos da guerra, escalação de cada jogo, Grade e o popover do player. Sai com Esc.</li><li>Fechar com alterações pendentes <b>pergunta se salva</b>.</li></ul></section>
...
<section class="guide-sec highlight"><h3>3 · Board (armado de PTs) <span class="tagimp">poco obvio</span></h3><ul><li>Con roster guardado, el modal <b>abre directo en el Board</b>. Arrastra players a PTs, reservas de PT o generales. Las columnas ruedan por separado.</li><li>Herramientas laterales: <b>⚙ Rellenar</b>, <b>🧹 Vaciar</b>, <b>🗂 Clase</b>, <b>🔗 Copiar</b> (enlace solo del board, sin escenas).</li><li><b>Replace con objetivo:</b> clic en un reserva → "⇄ Replace de" lista los titulares de SU PT. El sello aparece en ambos lados.</li><li><b>↔ Otras partidas:</b> con varias partidas en la guerra, el popover del jugador (y el <b>↔</b> del encabezado de la PT) lleva la posición — PT, reserva, función y torre — a las partidas marcadas. Ctrl+Z lo deshace.</li><li><b>Sábado y domingo juntos:</b> pega el enlace del evento del sábado y el del domingo en el Roster. El roster junta las dos inscripciones, la barra de partidas pasa a <b>Sáb G1…G5 | Dom G1…G5</b> y el board de cada día muestra a quien se inscribió en él (quien solo va el otro día queda atenuado en "Inscritos solo el otro día", arrastrable). El <b>⇉</b> replica la G1 del día en las partidas vacías, la Dom G1 nace como copia de la Sáb G1 sin quien no va el domingo, y el Cuadro tiene un selector Sáb/Dom (una imagen por día). La nota de raid-helper aparece como 📝 en la tarjeta y el popover.</li><li><b>⭐ Main roster:</b> en el popover del jugador, "Marcar como main roster". Vale para toda guerra de este navegador (por el userId de Discord): el ⚙ Rellenar los pone primero y aparecen arriba en Disponibles. El 📌 sigue siendo la PT fija de cada uno. Con varias partidas, cada tarjeta muestra <b>N/5</b>, cuántas partidas del día juega; <b>⛶ Pantalla</b> oculta las herramientas y agranda los nombres para la llamada de oficiales.</li><li><b>🎨 Tema:</b> Oscuro, Oscuro contraste, Claro o Planilla (colores de la planilla del staff: naranja Tank, azul DPS, verde Healer). Vale para el board, el Cuadro y la 🖼 Imagen, y queda en este navegador. <b>JG:</b> en el popover del jugador, elige su jungla (Roja, Blanca, Amarilla o Verde; las retrasadas y las avanzadas tienen los mismos colores). Vale para toda la guerra, aparece como moneda de color en la tarjeta y en una línea por color bajo el Cuadro y la imagen.</li><li><b>☁ Guardar enlace:</b> guarda el board con un nombre corto y una contraseña y genera <b>?s=nombre</b>. Cualquiera con el enlace lo abre; para regrabar hace falta la contraseña creada en el primer guardado. F5 en el enlace trae la versión más nueva.</li><li><b>⤓ Traer jugadores de otro board:</b> pega el enlace de un board antiguo (🔗 Copiar) o de un evento. Quien no está en el roster entra en la franja "Traídos de otro board", con sello ⤓, para arrastrar y simular. El ⚙ Rellenar los ignora y el ✕ limpiar quita a quien no fue alineado en ninguna partida.</li><li><b>Cambio en 1 clic:</b> en el sello ⇄ (pestaña Players) o en el menú del titular en el mapa — el reserva toma el lugar y la POSICIÓN; clic de nuevo lo deshace.</li><li><b>Tour del Board:</b> el botón <b>🎓</b> (junto a 🔗 Copiar) abre un tour guiado dentro del Board: partidas de la guerra, alineación de cada partida, Cuadro y el popover del jugador. Se sale con Esc.</li><li>Cerrar con cambios pendientes <b>pregunta si guardar</b>.</li></ul></section>
...
<section class="guide-sec highlight"><h3>3 · Board (PT setup) <span class="tagimp">not obvious</span></h3><ul><li>With a saved roster the modal <b>opens straight on the Board</b>. Drag players to PTs, PT reserves or general reserves. Columns scroll independently.</li><li>Side tools: <b>⚙ Fill</b>, <b>🧹 Empty</b>, <b>🗂 Class</b>, <b>🔗 Copy</b> (board-only link, no scenes).</li><li><b>Replace with target:</b> click a reserve → "⇄ Replaces" lists starters of THEIR PT. The badge shows on both sides.</li><li><b>↔ Other games:</b> with several games in the war, the player popover (and the <b>↔</b> on the PT header) sends the setup — PT, reserve, role and turret — to the ticked games. Ctrl+Z undoes it.</li><li><b>Saturday and Sunday together:</b> paste the Saturday event link and the Sunday one in the Roster. The roster merges both sign-ups, the games bar becomes <b>Sat G1…G5 | Sun G1…G5</b> and each day\u2019s board shows who signed up for it (people who only play the other day sit dimmed under "Signed up for the other day only", still draggable). <b>⇉</b> copies the day\u2019s G1 into the empty games, Sun G1 starts as a copy of Sat G1 minus whoever skips Sunday, and the Grid has a Sat/Sun switch (one image per day). The raid-helper note shows as 📝 on the card and in the popover.</li><li><b>⭐ Main roster:</b> in the player popover, "Mark as main roster". It applies to every war in this browser (by Discord userId): ⚙ Fill places them first and they sit on top of Available. 📌 is still each player\u2019s fixed PT. With several games each card shows <b>N/5</b>, how many of the day\u2019s games they play; <b>⛶ Big screen</b> hides the tools and enlarges names for the officers\u2019 call.</li><li><b>🎨 Theme:</b> Dark, Dark contrast, Light or Sheet (staff sheet colors: orange Tank, blue DPS, green Healer). It applies to the board, the Grid and the 🖼 Image, and is kept in this browser. <b>JG:</b> in the player popover pick their jungle (Red, White, Yellow or Green; back and forward camps share the colors). It applies to the whole war, shows as a colored coin on the card and as one line per color under the Grid and the image.</li><li><b>☁ Save link:</b> saves the board under a short name and a password and builds <b>?s=name</b>. Anyone with the link can open it; overwriting needs the password set on the first save. F5 on the link fetches the newest version.</li><li><b>⤓ Pull players from another board:</b> paste an old board link (🔗 Copy) or an event link. Anyone not in the roster lands in "Pulled from another board", with a ⤓ badge, ready to drag and simulate. ⚙ Fill ignores them and ✕ clear removes whoever was not rostered in any game.</li><li><b>1-click swap:</b> via the ⇄ badge (Players tab) or the starter's map menu — the reserve takes the slot and POSITION; click again to revert.</li><li><b>Board tour:</b> the <b>🎓</b> button (next to 🔗 Copy) opens a guided tour inside the Board itself: games in the war, the line-up of each game, the Grid and the player popover. Press Esc to leave.</li><li>Closing with pending changes <b>asks to save</b>.</li></ul></section>
...
<section class="guide-sec tips"><h3>Tips</h3><ul><li>Build the base in scene 1 and <b>Duplicate</b> per phase.</li><li>Save the <b>per-scene zoom</b> (📍) before presenting.</li><li><b>Auto-focus</b> + <b>Present</b> guide attention.</li><li>The <b>What's new</b> tab shows every change by version.</li></ul></section>` }
  ...
  let guideTab = 'guide', clCache = null, clTr = null;
  function fillGuide() {
  ...
  async function renderChangelog(b) {
    ...
    try {
      ...
      // EN/ES: tradução por linha em changelog-i18n.json (chave = texto PT); falhou ou faltou, fica o PT
      if (lang !== 'pt' && !clTr) { try { const r2 = await fetch('./changelog-i18n.json', { cache: 'no-store' }); clTr = r2.ok ? await r2.json() : {}; } catch (e) { clTr = {}; } }
      const trad = s => { const o = lang !== 'pt' && clTr && clTr[s]; return (o && o[lang]) || s; };
      const rows = [];
      ...
      rows.forEach(r => { if (r.d !== day) { day = r.d; h += '<div class="cl-day">' + esc(day) + '</div>'; } h += '<div class="cl-item"><span class="cl-v">' + esc(r.v) + '</span><span class="cl-t">' + esc(trad(r.t)) + '</span></div>'; });
  ...
  function setLang(l) {
    ...
    try { renderRail(); loadScenarioIntoUI(); updateSceneHud(); if (state.present) updatePresentUI(); updateWarsBtn(); renderObjPanel(); temaSelFill(); const gm = $('gradeModal'); if (gm && !gm.hidden) renderGrade(); } catch (e) {}
  }
  ...
  function init() {
    ...
    renderSidebar(); renderJogos(); renderRail(); loadScenarioIntoUI(); syncCanvasFill(cur()); fit(); applySceneView(cur()); updateZoomSaveBtn(); wireEvents(); (async () => { await maybeLoadShared(); await maybeLoadScenes(); await maybeLoadObj(); await maybeLoadBoard(); await maybeLoadCloud(); await maybeLoadPlan(); await maybeLoadCommand(); autoSyncRoster(maybeLoadRh()); maybeTour(); })();
  ...
  function renderPlayerChips() {
    ...
    players.forEach(p => {
      ...
      chip.innerHTML = icoHTML(p) + '<span class="pl-nm" title="' + esc(p.nome) + '">' + esc(nomeExib(p, 20)) + sabs + rep + '</span><span class="pl-pt">' + esc(where) + '</span><span class="pl-role">' + (placed ? t('onMap') : p.funcao) + '</span>';
  ...
  function openObjMenu(o, x, y) {
    ...
    let h = '<div class="im-hd"><span class="im-dot" style="background:' + st.c + '"></span><b>' + esc(objRotulo(o)) + '</b><button class="im-x" data-act="close">✕</button></div>';
  ...
  function togglePopover(pt, x, y) {
    ...
    let html = '<h4><span class="pd" style="background:' + p.cor + '"></span>' + (state.ptIcon[pt] ? ptIconHTML(state.ptIcon[pt]) + ' ' : '') + pt + (state.present ? '' : '<button class="po-edit">' + esc(t('editShort')) + '</button>') + '</h4>';
    ...
    if (!tit.length && !res.length) html += '<div class="empty">' + esc(t('poNoMembers')) + '</div>';
    else {
      html += '<ul>';
      ...
      res.forEach(m => html += '<li class="res"><span class="rl" style="background:' + roleColor(m.funcao) + ';opacity:.5"></span>' + esc(m.nome) + '<span class="tag">' + esc(t('poResTag')) + '</span></li>');
      html += '</ul>';
      if (!state.present) html += '<div class="phint">' + esc(t('poDragHint')) + '</div>';
    }
  ...
  function objInfoFor(o) { if (!o || !o.icone || !CFG.objInfo) return ''; const ic = o.icone; if (ic.indexOf('tower') === 0) return t(OBJ_INFO.tower); if (ic.indexOf('goose') === 0) return t(OBJ_INFO.goose); if (ic.indexOf('tree') === 0) return t(OBJ_INFO.tree); if (ic === 'jungle') return t(OBJ_INFO.jungle); return CFG.objInfo[ic] || ''; }
  ...
  function renderObjPanel() {
    ...
    CFG.objetivosGrupos.forEach(grp => {
      ...
      gh.innerHTML = '<input type="checkbox"' + (allUp ? ' checked' : '') + '><span class="chev">▸</span><span class="gname">' + cfgTxt(grp) + '</span><span class="gcount">' + nUp + '/' + list.length + '</span>';
      ...
      if (open) {
        ...
        list.forEach(o => {
          ...
          row.innerHTML = '<input type="checkbox"' + (up[o.id] ? ' checked' : '') + '><span class="on"></span><span class="nm">' + esc(objRotulo(o)) + '</span>';
  ...
  function editNoteInline(n) {
    ...
    bar.innerHTML = '<button type="button" data-a="dec" title="' + esc(t('noteSmall')) + '">A−</button><button type="button" data-a="inc" title="' + esc(t('noteBig')) + '">A＋</button><button type="button" data-a="color" class="ne-col" title="' + esc(t('noteColorTip')) + '"></button><button type="button" data-a="del" class="ne-del" title="' + esc(t('delLbl')) + '">✕</button>';
  ...
  function makeSceneCard(s, num, isVar) {
    ...
    const meta = s.condicao ? '<span class="sc-cond">▸ ' + esc(cfgTxt(s.condicao)) + '</span>' : '<span class="sc-meta">' + (isVar ? (t('variation') + (s.varLabel ? ' ' + esc(s.varLabel) : '')) : esc(cfgTxt(s.fase || ''))) + '</span>';
    const timeBadge = s.tempo ? '<span class="sc-time">⏱ ' + esc(s.tempo) + '</span>' : '';
    card.innerHTML = '<div class="sc-top"><span class="sc-idx' + (isVar ? ' sc-idx-var' : '') + '">' + num + '</span>' + timeBadge + '<span class="sc-name">' + esc(cfgTxt(s.nome) || t('sceneBtn')) + '</span></div>' + meta + '<button class="sc-del" title="' + esc(t('delLbl')) + '" aria-label="' + esc(t('delLbl')) + '">✕</button>';
  ...
  function buildSceneSel() {
    ...
    const mains = state.scenarios.filter(s => !(s.varOf && byId.has(s.varOf)));
    let html = '', ord = 0;
    mains.forEach(m => { ord++; const num = String(ord); html += '<option value="' + m.id + '">' + esc(num + '. ' + (cfgTxt(m.nome) || t('sceneAria')) + (m.tempo ? ' · ' + m.tempo : '')) + '</option>';
      state.scenarios.filter(x => x.varOf === m.id).forEach((v, vi) => { const vn = num + String.fromCharCode(97 + Math.min(25, vi)); html += '<option value="' + v.id + '">' + esc('   ' + vn + '. ' + (cfgTxt(v.nome) || 'Var') + (v.tempo ? ' · ' + v.tempo : '')) + '</option>'; }); });
  ...
  function loadScenarioIntoUI() { const s = cur(); if (!s) return; nameInput.value = cfgTxt(s.nome || ''); if (timeInput) timeInput.value = s.tempo || ''; condInput.value = cfgTxt(s.condicao || ''); noteInput.value = s.nota || ''; { const nw = $('noteWrap'), nt = $('noteTgl'); const has = !!(s.nota && s.nota.trim()); if (nw) nw.hidden = !has; if (nt) nt.classList.toggle('on', has); } updateMini(); }
  ...
  async function deleteScenario(id) {
    ...
    const tn = cfgTxt(target.nome || ''); const msg = kids.length ? t('sceneDelKids').replace('%s', tn).replace('%n', kids.length) : t('sceneDelOne').replace('%s', tn);
  ...
  function syncCard() { const s = cur(), card = rail.querySelector('.scene.active'); if (!card) return; card.querySelector('.sc-name').textContent = cfgTxt(s.nome) || t('sceneBtn'); const top = card.querySelector('.sc-top'); let timeEl = card.querySelector('.sc-time'); if (s.tempo) { if (!timeEl) { timeEl = document.createElement('span'); timeEl.className = 'sc-time'; const nameEl = top.querySelector('.sc-name'); top.insertBefore(timeEl, nameEl); } timeEl.textContent = '⏱ ' + s.tempo; } else if (timeEl) { timeEl.remove(); } const condEl = card.querySelector('.sc-cond'), metaEl = card.querySelector('.sc-meta'); if (s.condicao) { if (condEl) condEl.textContent = '▸ ' + s.condicao; else { const el = document.createElement('span'); el.className = 'sc-cond'; el.textContent = '▸ ' + s.condicao; if (metaEl) metaEl.replaceWith(el); else card.appendChild(el); } } else if (condEl) { const el = document.createElement('span'); el.className = 'sc-meta'; el.textContent = cfgTxt(s.fase || ''); condEl.replaceWith(el); } updateMini(); }
  function updateMini() { const s = cur(); if (s) miniName.textContent = (curIndex() + 1) + '. ' + (cfgTxt(s.nome) || t('sceneBtn')) + (s.tempo ? ' · ⏱ ' + s.tempo : '') + (s.condicao ? ' · ' + cfgTxt(s.condicao) : ''); const i = curIndex(); const mp = $('miniPrev'), mn = $('miniNext'); if (mp) mp.disabled = i <= 0; if (mn) mn.disabled = i >= state.scenarios.length - 1; updateSceneHud(); }
  ...
  function updateSceneHud() {
    ...
    tt.textContent = cfgTxt(s.nome) || t('sceneBtn');
    if (s.tempo) { tm.hidden = false; tm.textContent = '⏱ ' + s.tempo; } else tm.hidden = true;
    if (cd) { if (s.condicao) { cd.hidden = false; cd.textContent = '▸ ' + cfgTxt(s.condicao); } else cd.hidden = true; }
  ...
  function updatePresentUI() { const s = cur(); if (!s) return; const i = curIndex(), n = state.scenarios.length; pbTitle.textContent = cfgTxt(s.nome) || t('sceneBtn'); if (pbTime) { if (s.tempo) { pbTime.hidden = false; pbTime.textContent = '⏱ ' + s.tempo; } else pbTime.hidden = true; } if (s.condicao) { pbCond.hidden = false; pbCond.textContent = s.condicao; } else pbCond.hidden = true; pbProg.textContent = (i + 1) + ' / ' + n; pnPhase.textContent = cfgTxt(s.fase || s.nome) || t('faseLbl'); if (s.condicao) { pnBadge.hidden = false; pnBadge.textContent = cfgTxt(s.condicao); } else pnBadge.hidden = true; const nota = (s.nota || '').trim(); pnText.textContent = nota || t('sceneNoNote'); pnText.classList.toggle('empty', !nota); prevBtn.disabled = i <= 0; nextBtn.disabled = i >= n - 1; }
  ...
  function parseRoster(text) { text = (text || '').trim(); if (!text) return []; if (text[0] === '{' || text[0] === '[') { try { const d = JSON.parse(text); const arr = Array.isArray(d) ? d : (d.signUps || d.signups); if (Array.isArray(arr)) return parseRaidHelper(arr); } catch (e) {} } return parseLines(text); }
  // Uma inscrição nos dois dialetos da API numa visão só: v4 (camelCase,
  // signUps) e v1 (minúsculo, signups) — o raid-helper e o zhi-signups servem
  // os dois, e o board não deve exigir saber qual versão veio.
  function rhNorm(s) { return { name: s.name, className: s.className || s.cClassName || s.class || s.cClass || '', specName: s.specName || s.cSpecName || s.spec || s.cSpec || '', specEmoteId: s.specEmoteId != null ? s.specEmoteId : s.spec_emote, userId: s.userId != null ? s.userId : s.userid, note: s.note }; }
  function parseRaidHelper(signUps) { const out = []; signUps.forEach(x => { const s = rhNorm(x); const cls = s.className; let status = 'primary', ausente = false, reserva = false, classe = cls, funcao = 'DPS'; if (/^absence$/i.test(cls)) { status = 'absence'; ausente = true; classe = 'Absence'; } else if (/^bench$/i.test(cls)) { status = 'bench'; reserva = true; classe = s.specName || '—'; funcao = mapClass(classe); } else if (/^late$/i.test(cls)) { status = 'late'; classe = s.specName || '—'; funcao = mapClass(classe); } else if (/^tentative$/i.test(cls)) { status = 'tentative'; reserva = true; classe = s.specName || '—'; funcao = mapClass(classe); } else { classe = cls; funcao = mapClass(cls); } out.push({ id: uid(), nome: s.name || '—', classe, funcao, status, ausente, reserva, pt: null, nota: s.note || '', spec: s.specName || undefined, specEmote: (s.specEmoteId && /^\d{5,20}$/.test(String(s.specEmoteId))) ? String(s.specEmoteId) : undefined, disc: (s.userId != null && /^\d{5,20}$/.test(String(s.userId))) ? String(s.userId) : undefined }); }); const rank = p => (p.ausente ? 3 : p.reserva ? 2 : 1), fo = f => ({ Tank: 0, Healer: 1, DPS: 2 }[f] ?? 3); out.sort((a, b) => rank(a) - rank(b) || fo(a.funcao) - fo(b.funcao) || a.nome.localeCompare(b.nome)); return out; }
  ...
  function sanitizeJogo(j) {
    ...
    Object.keys(src).forEach(k => {
      const v = src[k] || {};
      const e = { pt: PT_IDS.includes(v.pt) ? v.pt : null, reserva: !!v.reserva };
      // funcao e torre variam de partida pra partida: o mesmo player pode ser DPS num jogo e
      // healer no outro, e a torre em que ele comeca e decisao do commander por jogo.
      if (['Tank', 'DPS', 'Healer'].indexOf(v.funcao) >= 0) e.funcao = v.funcao;
      if (TORRES.indexOf(v.torre) >= 0) e.torre = v.torre;
      esc[String(k)] = e;
    });
    const o = { id: (j && j.id) || uid(), nome: String((j && j.nome) || 'G1').slice(0, 24), nota: (j && typeof j.nota === 'string') ? j.nota.slice(0, 120) : '', escalacao: esc };
    if (j && DIAS.indexOf(j.dia) >= 0) o.dia = j.dia;
    return o;
  }
  const TORRES = ['top', 'mid', 'bot'];
  function serializeEscalacao() {
    const esc = {};
    state.roster.forEach(p => {
      if (!p.pt && !p.reserva && !p.torre) return;
      const e = { pt: p.pt || null, reserva: !!p.reserva };
      if (p.funcao) e.funcao = p.funcao;
      if (TORRES.indexOf(p.torre) >= 0) e.torre = p.torre;
      esc[p.id] = e;
    });
    return esc;
  }
  ...
  function applyEscalacao(j) {
    ...
    state.roster.forEach(p => {
      ...
      p.torre = (e && TORRES.indexOf(e.torre) >= 0) ? e.torre : undefined;
      p.funcao = (e && e.funcao) || p.funcaoBase || p.funcao;   // classe daquele jogo; sem nada, a do signup
    ...
    // Guerra de dois dias: ausência e "não se inscreveu" são do DIA do jogo aberto.
    if (j && j.dia) state.roster.forEach(p => diaStatus(p, j.dia));
  }
  // ---- eixo DIA (sábado e domingo na mesma guerra) ----
  // Liga quando existe o link do domingo (rhEvent2) ou algum jogo já tem dia. Cada player
  // guarda p.dias = { sab:'in'|'aus', dom:'in'|'aus' } (chave ausente = não se inscreveu
  // naquele dia) e p.notas por dia. ausente/outroDia são DERIVADOS do dia do jogo aberto.
  const DIAS = ['sab', 'dom'];
  const ultJogo = {};
  function diasOn() { return state.jogos.some(j => j.dia); }
  function jogoAtualObj() { return state.jogos.find(x => x.id === state.jogoAtual) || null; }
  function diaAtual() { const j = jogoAtualObj(); return (j && j.dia) || 'sab'; }
  function jogosDoDia(d) { return diasOn() ? state.jogos.filter(j => j.dia === d) : state.jogos; }
  function jogoLabel(j) { return (j && j.dia) ? t('dia_' + j.dia) + ' ' + j.nome : (j ? j.nome : ''); }
  function diaStatus(p, d) {
    if (!p.dias) { p.outroDia = undefined; return; }
    const st = p.dias[d];
    p.outroDia = st ? undefined : true;
    if (st === 'aus') { if (p.pt || p.reserva) { p.ausente = false; p.signupAusente = true; } else { p.ausente = true; p.signupAusente = undefined; } }
    else { p.ausente = false; p.signupAusente = undefined; }
  }
  function notaDe(p) { if (p.notas && diasOn()) return p.notas[diaAtual()] || ''; return p.nota || ''; }
  function escVazia(j) { return !Object.keys(j.escalacao || {}).some(k => { const e = j.escalacao[k]; return e && (e.pt || e.reserva || e.torre); }); }
  // Roda fn com o rascunho do board (se aberto) como verdade, igual ao switchJogo.
  function comRascunho(fn) {
    const editando = rosterModal && !rosterModal.hidden;
    if (editando) state.roster = rosterDraft.map(x => Object.assign({}, x));
    fn();
    if (editando) { rosterDraft = state.roster.map(x => Object.assign({}, x, { flags: (x.flags || []).slice() })); refreshRoster(); }
    saveProject(); renderSidebar(); renderTokens(); renderJogos();
  }
  function ligarDias() {
    if (diasOn()) return;
    ensureJogos();
    state.jogos.forEach(j => { j.dia = 'sab'; });
    applyEscalacao(jogoAtualObj());
  }
  // Dom Gn nasce como cópia do Sáb Gn, sem quem não se inscreveu (ou marcou ausência) no dia.
  function criarDia(d) {
    const base = state.jogos.filter(j => j.dia === (d === 'dom' ? 'sab' : 'dom'));
    const byId = new Map(state.roster.map(p => [p.id, p]));
    const vai = id => { const p = byId.get(id); return p && (!p.dias || p.dias[d] === 'in'); };
    const novos = (base.length ? base : [{ nome: 'G1', escalacao: {} }]).map(b => {
      const esc = {}; Object.keys(b.escalacao || {}).forEach(id => { if (vai(id)) esc[id] = JSON.parse(JSON.stringify(b.escalacao[id])); });
      return sanitizeJogo({ nome: b.nome, dia: d, escalacao: esc });
    });
    state.jogos.push(...novos);
    return novos[0];
  }
  function switchDia(d) {
    if (DIAS.indexOf(d) < 0 || (diasOn() && d === diaAtual())) return;
    if (!diasOn()) { comRascunho(() => { stashJogoAtual(); ligarDias(); }); if (d === 'sab') return; }
    let alvo = null;
    if (!jogosDoDia(d).length) { comRascunho(() => { stashJogoAtual(); alvo = criarDia(d); }); }
    const js = jogosDoDia(d);
    alvo = js.find(j => j.id === ultJogo[d]) || alvo || js[0];
    if (alvo) switchJogo(alvo.id);
  }
  // ⇉: copia o G1 do dia para os jogos VAZIOS do mesmo dia; cria até o G5. Jogo já montado não é tocado.
  function replicarG1() {
    let n = 0;
    comRascunho(() => {
      ensureJogos(); stashJogoAtual();
      const d = diaAtual(), on = diasOn();
      let js = jogosDoDia(d);
      const g1 = js[0]; if (!g1) return;
      while (js.length < 5) { state.jogos.push(sanitizeJogo({ nome: 'G' + (js.length + 1), dia: on ? d : undefined, escalacao: {} })); js = jogosDoDia(d); }
      js.slice(1).forEach(j => { if (!escVazia(j)) return; j.escalacao = JSON.parse(JSON.stringify(g1.escalacao)); n++; });
      applyEscalacao(jogoAtualObj());
    });
    toast(t('repOk').replace('%s', n));
  }
  ...
  function switchJogo(id) {
    ...
    if (!alvo) return;
    // Roster aberto: o rascunho é a verdade em edição — grava nele antes de trocar, senão
    // o que a pessoa acabou de arrastar se perde ao mudar de jogo.
    const editando = rosterModal && !rosterModal.hidden;
    if (editando) { state.roster = rosterDraft.map(x => Object.assign({}, x)); }
    stashJogoAtual();
    { const velho = jogoAtualObj(); if (velho && velho.dia) ultJogo[velho.dia] = velho.id; }
    state.jogoAtual = id;
    applyEscalacao(alvo);
    if (editando) { rosterDraft = state.roster.map(x => Object.assign({}, x, { flags: (x.flags || []).slice() })); refreshRoster(); }
    saveProject(); renderSidebar(); renderTokens(); renderJogos();
  ...
  function addJogo(dup) {
    ...
    const d = base && base.dia;
    const j = sanitizeJogo({ nome: 'G' + (jogosDoDia(d || 'sab').length + 1), dia: d, escalacao: (dup && base) ? JSON.parse(JSON.stringify(base.escalacao)) : {} });
  ...
  function delJogo(id) {
    ...
    const d = state.jogos[i].dia;
    if (d && jogosDoDia(d).length <= 1) return;   // cada dia fica com pelo menos um jogo
    const irmaos = jogosDoDia(d || 'sab'), k = irmaos.findIndex(x => x.id === id);
    const prox = irmaos[k > 0 ? k - 1 : 1];
    state.jogos.splice(i, 1);
    if (state.jogoAtual === id) { state.jogoAtual = prox.id; applyEscalacao(prox); }
    saveProject(); renderSidebar(); renderTokens(); renderJogos();
  }
  ...
  function wireJogoBar(wrap) {
    ...
    wrap.addEventListener('click', e => {
      ...
      else if (a === 'rep') replicarG1();
      else if (a.indexOf('dia:') === 0) switchDia(a.slice(4));
      else if (a === 'grade') openGrade();
      else if (a === 'del') { const j = state.jogos.find(x => x.id === state.jogoAtual); if (j && confirm(t('jogoDelAsk') + ' ' + jogoLabel(j) + '?')) delJogo(state.jogoAtual); }
  ...
  function renderJogos() {
    // Duas barras: a do painel de PTs e a de dentro do modal de roster. Mesmo HTML, mesma
    // delegação — trocar de jogo com o board aberto não obriga mais a fechar tudo.
    ['jogoBar', 'jogoBarRoster'].forEach(id => { const w = $(id); if (w) renderJogoBarEm(w); });
  }
  function renderJogoBarEm(wrap) {
    ...
    const d = diaAtual(), on = diasOn(), js = jogosDoDia(d);
    let h = '';
    h += '<span class="dia-tg" role="group">' + DIAS.map(x => chip('dia:' + x, t('dia_' + x) + ' · ' + (on ? jogosDoDia(x).length : (x === 'sab' ? state.jogos.length : 0)), 'dia-b' + (x === d ? ' on' : ''), t('dia_' + x))).join('') + '</span><span class="jogo-sep"></span>';
    h += '<span class="jogo-list">' + js.map(j => chip(j.id, j.nome, j.id === state.jogoAtual ? 'on' : '', jogoLabel(j) + (j.id === state.jogoAtual ? ' (atual)' : ''))).join('') + '</span>';
    h += '<span class="jogo-acts">' + chip('add', '+', 'jogo-add', t('jogoDup'));
    if (js.length < 5 || js.slice(1).some(escVazia)) h += chip('rep', '⇉', 'jogo-rep', t('jogoRep'));
    if (state.jogos.length > 1) h += chip('grade', '▦', 'jogo-grade', t('gradeTip'));
    if (js.length > 1) h += chip('del', '×', 'jogo-del', t('jogoDel'));
    h += '</span>';
    wrap.classList.toggle('com-dias', on);
    wrap.innerHTML = h;
  }
  ...
  // Nick de jogo vem cheio de enfeite (emoji, molduras, homóglifos) e estoura qualquer célula.
  // Isto é só para EXIBIR na grade e na imagem — o roster continua com o nome real, que é o
  // que casa com o raid-helper. Hífen e apóstrofo ficam: são parte de nome (Shin-il, Bai-zhi).
  // Apelido é SÓ rótulo: o nome real continua sendo a chave que casa com o raid-helper no
  // sync, e o disc (userId) segue intacto — a menção no Discord não muda. Serve para o caso
  // do nick enfeitado cujo apelido de verdade é outro ("Chibi", e não a moldura inteira).
  function nomeExib(p, max) { return p && p.apelido ? String(p.apelido).slice(0, max || 16) : nomeCurto(p ? p.nome : '', max); }
  const HOMO = { '¡': 'i', 'ǃ': 'l', '¿': 'c', '×': 'x', '†': 't' };
  function nomeCurto(s, max) {
    s = String(s || '').trim();
    let c = s.replace(/[¡ǃ¿×†]/g, ch => HOMO[ch] || ch)
      .replace(/[\p{Extended_Pictographic}\p{So}\p{Sk}\p{Cf}\p{Co}]/gu, '')
      .replace(/[\p{Ps}\p{Pe}\p{Pi}\p{Pf}\p{Po}]/gu, '')
      .replace(/^[\s\p{Pd}]+|[\s\p{Pd}]+$/gu, '')
      .replace(/\s+/g, ' ');
    if (c.replace(/\s/g, '').length < 2) c = s.replace(/\s+/g, ' ').trim();
    max = max || 16;
    return c.length > max ? c.slice(0, max - 1) + '…' : c;
  }
  // Grade de guerra com dois dias: um dia por vez (uma imagem por dia). gradeDia null = segue o jogo aberto.
  let gradeDia = null;
  function jogosGrade() { if (!diasOn()) return state.jogos; return jogosDoDia(gradeDia || diaAtual()); }
  function renderGradeDias() {
    const w = $('gradeDias'); if (!w) return;
    if (!diasOn()) { w.hidden = true; w.innerHTML = ''; return; }
    const cur = gradeDia || diaAtual();
    w.hidden = false;
    w.innerHTML = DIAS.map(d => '<button type="button" data-gd="' + d + '" class="' + (d === cur ? 'on' : '') + '">' + esc(t('dia_' + d)) + '</button>').join('');
    if (!w.dataset.wired) { w.dataset.wired = '1'; w.addEventListener('click', e => { const b = e.target.closest('[data-gd]'); if (!b) return; gradeDia = b.dataset.gd; renderGradeDias(); renderGrade(); }); }
  }
  let gradeMode = 'print'; // 'pt' = quem está em cada PT (visão de quem MONTA) · 'player' = onde cada um joga
  ...
  function gradeData() {
    ...
    const JG = jogosGrade();
    const byId = new Map(state.roster.map(p => [p.id, p]));
    const atual = JG.find(x => x.id === state.jogoAtual) || JG[0];
    const usados = new Set();
    JG.forEach(j => Object.keys(j.escalacao).forEach(id => { if (byId.has(id) && j.escalacao[id].pt) usados.add(id); }));
    ...
    if (gradeMode === 'sheet') {
        ...
        for (let i = 0; i < alt; i++) {
          linhas.push({
            ...
            cels: porJogo.map((col, j) => {
              const p = col[i];
              // slot que existia e sumiu: marca a saída, senão a troca só aparece de um lado
              if (!p) return (j > 0 && porJogo[j - 1][i]) ? { saiu: true, full: porJogo[j - 1][i].nome } : null;
              const antes = j > 0 && porJogo[j - 1].some(x => x.id === p.id);
              return { txt: nomeExib(p), full: p.nome, cor: roleColor(p.funcao), novo: j > 0 && !antes, emote: specIcons ? specEmoteDe(p) : null, tor: (JG[j].escalacao[p.id] || {}).torre };
            })
          });
        }
      ...
      PT_IDS.forEach(pid => {
        const ids = [...usados].filter(id => JG.some(j => { const e = j.escalacao[id]; return e && e.pt === pid; })).sort(ord);
        if (!ids.length) return;
        const linhas = ids.map(id => ({ label: nomeExib(byId.get(id)), full: byId.get(id).nome, cor: roleColor(byId.get(id).funcao), emote: specIcons ? specEmoteDe(byId.get(id)) : null, cels: JG.map(j => cel(j, id, pid)) }));
      ...
      const linhaDe = id => ({ label: nomeExib(byId.get(id)), full: byId.get(id).nome, cor: roleColor(byId.get(id).funcao), emote: specIcons ? specEmoteDe(byId.get(id)) : null, cels: JG.map(j => cel(j, id)) });
    ...
    return { jogos: JG.map(jogoLabel), notas: JG.map(j => j.nota || ''), secs };
  }
  ...
  // É a leitura de quem monta ("quem está na PT4 deste jogo") sem precisar varrer a horizontal.
  function printData() {
    ensureJogos(); stashJogoAtual();
    const JG = jogosGrade();
    const byId = new Map(state.roster.map(p => [p.id, p]));
    // Função daquele jogo (o mesmo player pode ser DPS num jogo e Healer em outro); a
    // função viva de state.roster é só a do jogo aberto e pintava a imagem errada.
    const fDe = (j, id) => (j.escalacao[id] && j.escalacao[id].funcao) || byId.get(id).funcaoBase || byId.get(id).funcao;
    return JG.map((j, ji) => {
      const ord = (a, b) => FO(fDe(j, a)) - FO(fDe(j, b)) || byId.get(a).nome.localeCompare(byId.get(b).nome);
      const antes = ji > 0 ? JG[ji - 1].escalacao : null;
      const grupos = (CFG.grupos || []).map(g => ({
        nome: grpNome(g.nome),
        pts: (g.pts || []).map(pid => {
          const ids = Object.keys(j.escalacao)
            .filter(id => byId.has(id) && j.escalacao[id].pt === pid && !j.escalacao[id].reserva).sort(ord);
          return {
            pt: pid, cor: (partyById.get(pid) || {}).cor,
            membros: ids.map(id => ({
              p: byId.get(id), f: fDe(j, id), tor: j.escalacao[id].torre, emote: specIcons ? specEmoteDe(byId.get(id)) : null,
              novo: !!antes && !(antes[id] && antes[id].pt === pid)
            }))
          };
        })
      }));
      const alt = Math.max.apply(null, grupos.reduce((a, g) => a.concat(g.pts.map(x => x.membros.length)), [0]));
      return { nome: jogoLabel(j), nota: j.nota || '', grupos, alt: Math.max(alt, 1) };
    });
  }
  function renderPrint(body) {
    const jogos = printData();
    let h = '';
    jogos.forEach((j, ji) => {
      h += '<div class="pr-jogo">';
    ...
    const jl = jgLinhas();
    if (jl.length) h += '<div class="pr-jgs">' + jl.map(l => '<div class="pr-jgl"><span class="pr-jgd" style="background:' + l.cor + '"></span><b>' + esc(l.rotulo) + '</b> ' + esc(l.nomes.join(', ')) + '</div>').join('') + '</div>';
    body.innerHTML = h;
    return jogos;
  }
  function renderGrade() {
    const body = $('gradeBody'); if (!body) return;
    { const hint = document.querySelector('.grade-hint');
      if (hint) hint.innerHTML = esc(t(gradeMode === 'print' ? 'gradeHintPrint' : 'gradeHint'))
        + ' <span class="lg"><b class="t-top">' + t('tor_top') + '</b> ' + esc(t('lgTop'))
        + ' · <b class="t-mid">' + t('tor_mid') + '</b> ' + esc(t('lgMid'))
        + ' · <b class="t-bot">' + t('tor_bot') + '</b> ' + esc(t('lgBot')) + '</span>'; }
    if (gradeMode === 'print') return renderPrint(body);
    const d = gradeData();
    let h = '<table class="grade-tb"><thead><tr><th>' + esc(gradeMode === 'sheet' ? t('gradeColSlot') : (gradeMode === 'pt' ? t('gradeColPt') : t('player'))) + '</th>';
    // uma observação por jogo — o que o commander quer lembrar daquela partida
    let obs = '<tr class="g-obs"><td class="g-obs-l">' + esc(t('gradeObs')) + '</td>';
    d.notas.forEach((n, i) => { obs += '<td class="g-obs-c" data-obs="' + i + '" title="' + esc(t('gradeObsTip')) + '">' + (n ? esc(n) : '<i>+</i>') + '</td>'; });
    obs += '</tr>';
    ...
    d.secs.forEach(s => {
      ...
      s.linhas.forEach(l => {
        ...
        l.cels.forEach((c, i) => {
          ...
          if (c && c.saiu) { h += '<td class="g-ch g-saiu" title="' + esc(c.full || '') + '">—</td>'; return; }
  ...
  // PNG do modo planilha: mesmo desenho da tela, em canvas 2D (sem dependência externa).
  async function printPNG() {
    const PAL = imgPal();
    const jogos = printData();
    // Sem pré-carregar, drawImage num Image ainda não carregado desenha nada — e o canvas
    // é síncrono, não dá pra esperar no meio do desenho.
    const imgs = new Map();
    if (specIcons) {
      const ids = new Set();
    ...
    jogos.forEach(j => {
      ...
      y += HH;
      for (let i = 0; i < j.alt; i++) {
        g.fillStyle = PAL.muted; g.font = '10px system-ui,sans-serif'; g.textAlign = 'right';
        g.fillText(String(i + 1), PAD + NW - 10, y + RH / 2); g.textAlign = 'left';
        cx = PAD + NW;
        j.grupos.forEach(gr => gr.pts.forEach(x => {
          const m = x.membros[i];
          if (m) {
        ...
        g.strokeStyle = PAL.grid; g.beginPath(); g.moveTo(PAD, y + RH + .5); g.lineTo(W - PAD, y + RH + .5); g.stroke();
        y += RH;
      }
      y += GAP;
    });
    // Jungles: uma linha por cor com quem cuida dela (vale para a guerra inteira).
    jgLinhas().forEach(l => {
      g.fillStyle = l.cor; g.beginPath(); g.arc(PAD + 8, y + 9, 6, 0, Math.PI * 2); g.fill();
      g.strokeStyle = PAL.dim; g.stroke();
      g.fillStyle = PAL.text; g.font = 'bold 11px system-ui,sans-serif'; g.fillText(l.rotulo, PAD + 20, y + 9);
      g.font = '11px system-ui,sans-serif'; g.fillText(l.nomes.join(', ') || '—', PAD + 20 + g.measureText(l.rotulo + '  ').width + 6, y + 9);
      y += 20;
    });
    // legenda: sem ela, T/M/B e o destaque não se explicam para quem só recebe a imagem
    ...
    seg(t('tor_top'), PAL.tc.top); seg(t('lgTop') + ' ·', PAL.muted);
    seg(t('tor_mid'), PAL.tc.mid); seg(t('lgMid') + ' ·', PAL.muted);
    seg(t('tor_bot'), PAL.tc.bot); seg(t('lgBot') + ' ·', PAL.muted);
    seg(t('lgCh'), PAL.gold);
    g.fillStyle = PAL.dim; g.textAlign = 'right';
    g.fillText('Game Plan · ' + jogos.length + ' ' + t(jogos.length === 1 ? 'lgJogo' : 'lgJogos'), W - PAD, H - PAD + 2);
    g.textAlign = 'left';
    return cv;
  }
  async function gradePNG() {
    ...
    g.textBaseline = 'middle';
    let y = PAD;
    g.fillStyle = PAL.head; g.fillRect(PAD, y, NW + CW * d.jogos.length, HH);
    g.fillStyle = PAL.gold; g.font = 'bold 11px system-ui,sans-serif';
    ...
    y += HH;
    if (d.notas.some(n => n)) {
      g.fillStyle = PAL.head2; g.fillRect(PAD, y, NW + CW * d.jogos.length, RH);
      g.fillStyle = PAL.muted; g.font = '10px system-ui,sans-serif';
      g.fillText(String(t('gradeObs')).toUpperCase(), PAD + 10, y + RH / 2);
      if (gradeMode === 'sheet') {
        // coluna larga: cada nota fica sob o seu jogo
        d.notas.forEach((n, i) => {
          if (!n) return;
          g.fillStyle = PAL.muted2; g.font = 'italic 11px system-ui,sans-serif';
        ...
        g.fillStyle = PAL.muted2; g.fillText(tx, PAD + 46, y + RH / 2);
      }
      y += RH;
    }
    let gAtual = null;
    d.secs.forEach(s => {
      if (s.grupo && s.grupo !== gAtual) {
        gAtual = s.grupo;
        g.fillStyle = PAL.head2; g.fillRect(PAD, y, NW + CW * d.jogos.length, RH - 4);
        g.fillStyle = PAL.muted; g.font = 'bold 9px system-ui,sans-serif';
        g.fillText(String(s.grupo).toUpperCase(), PAD + 10, y + (RH - 4) / 2);
        y += RH - 4;
      }
      g.fillStyle = PAL.head; g.fillRect(PAD, y, NW + CW * d.jogos.length, RH);
      if (s.cor) { g.fillStyle = s.cor; g.fillRect(PAD, y, 3, RH); }
      g.fillStyle = s.cor || PAL.muted2; g.font = 'bold 10px system-ui,sans-serif';
      ...
      s.linhas.forEach(l => {
        ...
        g.fillStyle = l.cor ? PAL.text : PAL.muted; g.font = '12px system-ui,sans-serif';
        ...
        l.cels.forEach((c, i) => {
          ...
          if (c && typeof c === 'object') {
            ...
            if (c.tor) {   // mesma marca do modo Planilha: letra fina, sem caixa
              g.fillStyle = { top: PAL.tc.top, mid: PAL.tc.mid, bot: PAL.tc.bot }[c.tor];
              g.font = 'bold 9px system-ui,sans-serif';
              g.fillText(t('tor_' + c.tor), x0 + CW - 16, y + RH / 2);
            }
            return;
          }
          const mudou = i > 0 && c !== l.cels[i - 1];
          if (mudou) { g.fillStyle = PAL.novo; g.fillRect(x0, y, CW, RH); }
          g.fillStyle = mudou ? PAL.gold : (c ? PAL.text : PAL.muted);
  ...
  async function entregarPNG(cv) {
    ...
    if (!blob) { toast(t('gradeFail')); return; }
    try {
  ...
  function openGrade() {
    const m = $('gradeModal'); if (!m) return;
    gradeDia = null; renderGradeDias();
    renderGrade(); m.hidden = false;
    const body = $('gradeBody');
    if (body && !body.dataset.wired) {
      body.dataset.wired = '1';
      body.addEventListener('click', e => {
        const c = e.target.closest('.g-obs-c') || e.target.closest('.pr-obs'); if (!c) return;
        const j = jogosGrade()[+c.dataset.obs]; if (!j) return;
        const v = prompt(t('gradeObsAsk') + ' ' + j.nome, j.nota || '');
        if (v === null) return;
        j.nota = v.trim().slice(0, 120); saveProject(); renderGrade();
      });
    }
  }
  ...
  // Quatro abas no topo em vez de um botão que cicla: dá pra ir direto ao formato que se quer.
  function syncGradeSwap() {
    const w = $('gradeTabs'); if (!w) return;
    w.querySelectorAll('[data-gm]').forEach(b => b.classList.toggle('active', b.dataset.gm === gradeMode));
  }
  ...
  function preserveIdentity(parsed) {
    ...
    parsed.forEach(np => {
      ...
      if (!np.apelido && prev.apelido) np.apelido = prev.apelido;
      if (!np.funcaoBase && prev.funcaoBase) np.funcaoBase = prev.funcaoBase;
      if (prev.manual) np.manual = true;
      if (!np.specEmote && prev.specEmote) np.specEmote = prev.specEmote;
    });
    return parsed;
  }
  // Identidade de player: o userId do Discord (p.disc) quando existe. Nome muda (Rhaela teve 3
  // grafias com o mesmo id; o petrichor antigo é o pto de hoje) e casar por nome duplicava gente.
  // ⭐ Main roster: vale para TODA guerra deste navegador (chave própria, por userId), então
  // o board novo já nasce sabendo quem joga todos os jogos. O ⚙ Preencher coloca essas
  // pessoas primeiro, a lista de disponíveis as mostra no topo e o card ganha o selo ⭐.
  const MAIN_KEY = 'zhi_main_roster_v1';
  let mainSet = new Set(); try { mainSet = new Set(JSON.parse(localStorage.getItem(MAIN_KEY) || '[]')); } catch (e) {}
  function isMain(p) { return !!p && mainSet.has(pKey(p)); }
  function toggleMain(p) { const k = pKey(p); if (mainSet.has(k)) mainSet.delete(k); else mainSet.add(k); try { localStorage.setItem(MAIN_KEY, JSON.stringify([...mainSet])); } catch (e) {} }
  // Quantos jogos do dia aberto cada player joga como titular (o jogo aberto conta pelo rascunho).
  function contaJogos() {
    const js = jogosDoDia(diaAtual()), cnt = new Map();
    if (js.length < 2) return { cnt, tot: js.length };
    js.forEach(j => {
      if (j.id === state.jogoAtual) rosterDraft.forEach(p => { if (p.pt && !p.reserva) cnt.set(p.id, (cnt.get(p.id) || 0) + 1); });
      else Object.keys(j.escalacao || {}).forEach(id => { const x = j.escalacao[id]; if (x && x.pt && !x.reserva) cnt.set(id, (cnt.get(id) || 0) + 1); });
    });
    return { cnt, tot: js.length };
  }
  let bdCnt = { cnt: new Map(), tot: 0 };
  function pKey(p) { return p && p.disc ? 'u:' + p.disc : 'n:' + String((p && p.nome) || '').trim().toLowerCase(); }
  function mergeRoster(parsed) {
    const norm = s => (s || '').trim().toLowerCase();
    const newByKey = new Map(), newByName = new Map();
    parsed.forEach(p => { newByKey.set(pKey(p), p); newByName.set(norm(p.nome), p); });
    const achar = p => newByKey.get(pKey(p)) || (!p.disc ? newByName.get(norm(p.nome)) : null) || null;
    const usados = new Set();
    let kept = 0, added = 0, removed = 0;
    const result = [];
    rosterDraft.forEach(p => {
      const np = achar(p);
      if (np) { usados.add(np); if (np.nome && np.nome !== p.nome && p.disc && np.disc === p.disc) p.nome = np.nome; }
      // Player adicionado à mão não existe no raid-helper por definição: sem esta guarda o
      // autoSync (que roda a CADA carregamento) apagava essas pessoas silenciosamente.
      ...
      if (np.dias) {   // guerra de dois dias: status e nota são por dia, derivados em diaStatus
        p.dias = np.dias; p.notas = np.notas; p.nota = np.nota || '';
        diaStatus(p, diaAtual()); result.push(p); kept++; return;
      }
      if (typeof np.nota === 'string' && np.nota) p.nota = np.nota;
    ...
    parsed.forEach(np => { if (!usados.has(np)) { if (np.dias) diaStatus(np, diaAtual()); result.push(np); added++; } });
    rosterDraft = result;
    return { kept, added, removed };
  }
  // ---- integração por link de evento: o link vira fonte viva do roster ----
  // As duas APIs (zhi-signups e raid-helper.xyz, /api/v4/events/<id>) devolvem
  // o mesmo signUps do "Web view" e liberam CORS, então dá pra buscar direto
  // do navegador.
  function rhEventId(v) { const m = /(\d{15,20})/.exec(v || ''); return m ? m[1] : null; }
  // Bases candidatas, em ordem: a origem do próprio link (o evento "sabe" de
  // onde veio — colar o link do zhi-signups busca no zhi-signups), depois as
  // de CFG.rosterApis (raid-helper.xyz de reserva, para eventos antigos).
  function rhApiBases(link) {
    const bases = [];
    try { bases.push(new URL(link).origin + '/api/v4/events/'); } catch (e) {}
    (CFG.rosterApis || ['https://raid-helper.xyz/api/v4/events/']).forEach(b => { if (bases.indexOf(b) < 0) bases.push(b); });
    return bases;
  }
  async function fetchRaidHelper(id, link) {
    const bases = rhApiBases(link);
    for (let i = 0; i < bases.length; i++) {
      try {
        const res = await fetch(bases[i] + id, { cache: 'no-store' });
        if (!res.ok) continue;
        const d = await res.json();
        const arr = d.signUps || d.signups;
        const parsed = Array.isArray(arr) ? parseRaidHelper(arr) : [];
        if (parsed.length) return parsed;
      } catch (e) {}
    }
    throw 0;
  }
  // Sábado + domingo: busca os dois eventos e junta num roster só. Cada player leva
  // dias = { sab, dom } ('in' inscrito, 'aus' marcou ausência; sem chave = não se inscreveu)
  // e a nota de cada dia. Os campos-base (classe, função) vêm do dia em que ele joga.
  async function fetchRoster() {
    const id1 = rhEventId(state.rhEvent), id2 = rhEventId(state.rhEvent2);
    if (!id2) return fetchRaidHelper(id1, state.rhEvent);
    const [a, b] = await Promise.all([id1 ? fetchRaidHelper(id1, state.rhEvent) : Promise.resolve([]), fetchRaidHelper(id2, state.rhEvent2)]);
    const out = new Map();
    [['sab', a], ['dom', b]].forEach(([d, lst]) => lst.forEach(p => {
      const k = pKey(p); let o = out.get(k);
      if (!o || (o.ausente && !p.ausente)) { const prev = o; o = Object.assign({}, p, { dias: prev ? prev.dias : {}, notas: prev ? prev.notas : {} }); out.set(k, o); }
      o.dias[d] = p.ausente ? 'aus' : 'in';
      if (p.nota) o.notas[d] = p.nota;
    }));
    return [...out.values()].map(o => { o.nota = o.notas.sab || o.notas.dom || ''; return o; });
  }
  // ⤓ Puxar players de outro board: aceita link de board (#b=) ou de evento. Quem ainda não
  // está no roster entra como manual + extra (o sync não apaga manual) e fica numa faixa
  // própria, arrastável para simular. Posição, dias e ausência do board antigo não vêm junto.
  async function puxarExtras(link) {
    link = (link || '').trim(); if (!link) return;
    let lista = [];
    const mb = /[#&]b=([^&\s]+)/.exec(link);
    try {
      if (mb) { const d = await decodeShare(decodeURIComponent(mb[1])); if (d && Array.isArray(d.roster)) lista = d.roster.map(sanitizePlayer); }
      else { const id = rhEventId(link); if (id) lista = await fetchRaidHelper(id, link); }
    } catch (e) { toast('⚠️ ' + t('linkInvalid')); return; }
    const norm = x => (x || '').trim().toLowerCase();
    const temK = new Set(rosterDraft.map(pKey)), temN = new Set(rosterDraft.map(p => norm(p.nome)));
    const vistos = new Set();
    const novos = lista.filter(p => {
      if (!p || !p.nome || /^absence$/i.test(p.classe || '')) return false;
      const k = pKey(p); if (vistos.has(k)) return false; vistos.add(k);
      return p.disc ? !temK.has(k) : !temN.has(norm(p.nome));
    });
    if (!novos.length) { toast(t('extraNone')); return; }
    pushBdUndo();
    novos.forEach(p => rosterDraft.push({ id: uid(), nome: p.nome, apelido: p.apelido, classe: p.classe || p.funcao, funcao: p.funcaoBase || p.funcao || 'DPS', funcaoBase: p.funcaoBase || p.funcao, status: 'primary', ausente: false, reserva: false, pt: null, tags: [], flags: [], replace: false, manual: true, extra: true, disc: p.disc, spec: p.spec, specEmote: p.specEmote, nota: '' }));
    refreshRoster();
    toast(t('extraOk').replace('%s', novos.length));
  }
  // ao abrir o app com link salvo: busca e mescla em silêncio (avisa só se
  // mudou algo). Vindo do botão Game Plan do Discord (?rh= na URL), avisa
  // sempre — inclusive quando falha: "não acontece nada" não é resposta.
  async function autoSyncRoster(loud) {
    if (!rhEventId(state.rhEvent) && !rhEventId(state.rhEvent2)) return;
    if (rhEventId(state.rhEvent2)) ligarDias();
    let parsed; try { parsed = await fetchRoster(); } catch (e) { if (loud) toast('⚠️ ' + t('rhFail')); return; }
    ...
    if (!r.added && !r.removed && JSON.stringify(rosterDraft) === before) { if (loud) toast('🔄 ' + t('rhSynced')); return; }
    applyRosterDraft();
    toast('🔄 ' + t('rhSynced') + ' — ' + r.kept + ' ' + t('mKept') + ' · ' + r.added + ' ' + t('mAdded') + ' · ' + r.removed + ' ' + t('mRemoved'));
    if (rosterModal && !rosterModal.hidden) { rosterDraft = state.roster.map(p => Object.assign({}, p, { flags: (p.flags || []).slice() })); refreshRoster(); }
  }
  // ---- ?rh=<id ou link do evento>: o botão Game Plan do Discord cai aqui ----
  // Guardar o valor em state.rhEvent é o que liga o autoSyncRoster() do boot;
  // devolve true para o boot avisar o resultado (o link foi um clique de gente).
  function maybeLoadRh() {
    const m = /[?&]rh=([^&]+)/.exec(location.search); if (!m) return false;
    let v = m[1]; try { v = decodeURIComponent(v); } catch (e) {}
    if (!rhEventId(v)) return false;
  ...
  function openRoster() { rosterDraft = state.roster.map(p => Object.assign({}, p, { flags: (p.flags || []).slice() })); rosterPaste.value = ''; { const rl = $('rhLink'); if (rl) rl.value = state.rhEvent || ''; const rl2 = $('rhLink2'); if (rl2) rl2.value = state.rhEvent2 || ''; } parseMsg.textContent = ''; parseMsg.className = 'parse-msg'; saveMsg.textContent = ''; renderGrid(); setRosterView(state.roster.length ? 'board' : 'grid'); rosterModal.hidden = false; }
  ...
  function renderGrid() {
    ...
    const c = { Tank: 0, Healer: 0, DPS: 0 }; rosterDraft.filter(p => !p.ausente && !p.reserva).forEach(p => { c[p.funcao] = (c[p.funcao] || 0) + 1; }); gComp.innerHTML = CFG.roleOrder.filter(f => c[f]).map(f => '<b style="--rc:' + roleColor(f) + ';color:var(--rc)">' + c[f] + '</b> ' + f).join(' · ');
    ...
    rosterDraft.forEach((p, i) => { const opts = ['Tank', 'DPS', 'Healer'].map(f => '<option value="' + f + '"' + (p.funcao === f ? ' selected' : '') + '>' + f + '</option>').join(''); const ptopts = '<option value="">—</option>' + PT_IDS.map(id => '<option value="' + id + '"' + (p.pt === id ? ' selected' : '') + '>' + id + '</option>').join(''); html += '<div class="rrow' + (p.ausente ? ' absence' : '') + '" data-i="' + i + '"><div class="rn"><span class="rl" style="background:' + roleColor(p.funcao) + (p.ausente ? ';opacity:.4' : '') + '"></span><span class="nm ednm" title="' + esc(p.apelido ? p.nome : t('nickEdit')) + '">' + esc(nomeExib(p, 22)) + (p.apelido ? '<i class="nick-a">✎</i>' : '') + '</span><span class="cl">' + esc(p.ausente ? 'ausente' : p.classe) + '</span></div><select class="f-fn"' + (p.ausente ? ' disabled' : '') + '>' + opts + '</select><select class="f-pt"' + (p.ausente ? ' disabled' : '') + '>' + ptopts + '</select><div class="res"><input type="checkbox" class="f-res"' + (p.reserva ? ' checked' : '') + (p.ausente ? ' disabled' : '') + '></div><button class="rdel" title="Remover">✕</button></div>'; });
  ...
  function autoAssign() {
    pushBdUndo();
    rosterDraft.forEach(p => { if ((p.outroDia || p.extra) && !p.ausente) { p.pt = null; p.reserva = false; } });
    const players = rosterDraft.filter(p => !p.ausente && !p.outroDia && !p.extra);
    ...
    // ⭐ main roster na frente da fila: sobrando gente, quem vira reserva é quem não é main.
    const free = players.filter(p => !p.pt).sort((a, b) => (isMain(b) ? 1 : 0) - (isMain(a) ? 1 : 0));
  ...
  function bdUndo() {
    if (!bdUndoStack.length) { toast('↩︎ —'); return; }
    let snap = null; try { snap = JSON.parse(bdUndoStack.pop()); } catch (e) { return; }
    if (snap && snap.__dup) {            // desfaz a cópia entre jogos
      Object.keys(snap.__dup).forEach(gid => {
        const j = state.jogos.find(x => x.id === gid); if (!j) return;
        const mapa = (j.escalacao = j.escalacao || {});
        Object.keys(snap.__dup[gid]).forEach(pid => { const v = snap.__dup[gid][pid]; if (v) mapa[pid] = v; else delete mapa[pid]; });
      });
      if (snap.draft) rosterDraft = snap.draft;
      saveProject(); renderJogos(); refreshRoster(); toast(t('bdUndone')); return;
    }
    rosterDraft = snap; refreshRoster(); toast(t('bdUndone'));
  }

  /* ---- levar a posição do player (ou a PT inteira) para outros jogos da guerra ----
     O espelho sai da verdade VIVA do jogo atual (rosterDraft) e vai para o
     jogos[].escalacao dos jogos escolhidos, no mesmo formato do serializeEscalacao. */
  function dupTargetGames() { return state.jogos.filter(j => j.id !== state.jogoAtual); }
  function dupEscEntries(pids) {
    const mapa = {};
    pids.forEach(id => {
  ...
  function dupGamesHTML(pids) {
    const alvos = dupTargetGames();
    if (!alvos.length) return '';
    let h = '<div class="bp-sec">' + t('dupTitle') + '</div><div class="bp-help">' + t('dupHelp') + '</div><div class="bp-games">';
    alvos.forEach(j => { h += '<label class="bp-g"><input type="checkbox" data-g="' + esc(j.id) + '"' + (!j.dia || j.dia === diaAtual() ? ' checked' : '') + '><span>' + esc(jogoLabel(j) || j.id) + '</span></label>'; });
    h += '</div><div class="bp-row"><button class="bp-gall">' + t('dupAll') + '</button><button class="bp-gnone">' + t('dupNone') + '</button></div>';
    h += '<div class="bp-row"><button class="bp-dup-go">' + t('dupGo') + '</button><button class="bp-dup-cancel">' + t('btnCancel') + '</button></div>';
    h += '<input type="hidden" class="bp-dup-pids" value="' + esc(pids.join(',')) + '">';
    return h;
  }
  let bdPopAnchor = null, bdDupOrigin = 'player';
  function openDupChooser(pids, titulo, anchor, origem) {
    if (!bdPop) return;
    if (!dupTargetGames().length) { toast(t('dupNoGames')); return; }
    bdDupOrigin = origem || 'player';
    bdPop.innerHTML = '<div class="bp-nm">' + esc(titulo) + '</div>' + dupGamesHTML(pids);
    bdPop.hidden = false; placeBdPop(anchor);
  }
  function dupToGames(pids, gameIds) {
    const mapa = dupEscEntries(pids), ids = Object.keys(mapa);
    const prev = {}; let n = 0;
    (gameIds || []).forEach(gid => {
      const j = state.jogos.find(x => x.id === gid);
      if (!j || j.id === state.jogoAtual) return;
      j.escalacao = j.escalacao || {};
      prev[gid] = {}; n++;
      ids.forEach(id => { prev[gid][id] = j.escalacao[id] ? Object.assign({}, j.escalacao[id]) : null; j.escalacao[id] = Object.assign({}, mapa[id]); });
    });
    if (!ids.length) { toast(t('dupNoPlace')); return 0; }
    if (!n) return 0;
    try { bdUndoStack.push(JSON.stringify({ __dup: prev, draft: rosterDraft })); if (bdUndoStack.length > 40) bdUndoStack.shift(); } catch (e) {}
    saveProject(); renderBoard(); renderJogos();
    try { renderGrade(); } catch (e) {}
    return n;
  }
  ...
  // ---- ícones de spec do raid-helper ----
  // O signup traz specEmoteId por inscrito; o CDN do Discord serve o PNG com CORS aberto
  // (access-control-allow-origin: *), então dá pra usar tanto na tela quanto no canvas da
  // imagem. O mapa abaixo é só rede: se o player veio sem specEmote (roster antigo, colado à
  // mão), ainda dá pra achar o ícone pela spec.
  const SPEC_EMOTE = {
    Stonesplit_Might: '1448852644352364546',
    Stonesplit_Strength: '1491036473900925099',
    Bellstrike_Splendor: '1448851985486053530',
    Bamboocut_Wind: '1448851955941376132',
    Bamboocut_Dust: '1479381801570013307',
  ...
  // Substitui o ícone de função pelo da spec quando a opção está ligada e o player tem um.
  function icoHTML(p, sm) {
    const id = specIcons ? specEmoteDe(p) : null;
    if (!id) return classIcoHTML(p.funcao, sm);
    return '<span class="c-ico' + (sm ? ' sm' : '') + ' spec" style="--rc:' + roleColor(p.funcao) + '" title="' + esc(p.classe || p.funcao) + '"><img src="' + emoteUrl(id) + '" alt="" loading="lazy"></span>';
  }
  const specImgCache = new Map();
  function loadSpecImg(id) {
    if (specImgCache.has(id)) return specImgCache.get(id);
    const pr = new Promise(res => {
      const i = new Image();
      i.crossOrigin = 'anonymous';   // sem isto o canvas fica contaminado e o toBlob falha
      i.onload = () => res(i); i.onerror = () => res(null);
      i.src = emoteUrl(id);
    });
    specImgCache.set(id, pr); return pr;
  }
  ...
  function bdChip(p) {
    ...
    const pin = (isMain(p) ? '<span class="c-main" title="⭐ ' + esc(t('mainTip')) + '">⭐</span>' : '') + (p.fix ? '<span class="c-pin" title="📌 ' + esc(t('fixLbl')) + '">📌</span>' : '');
    // N/5 só onde ajuda a decidir: quem está fora de algum jogo. 5/5 em todo titular e 0/5 em
    // todo ausente era ruído (medido no board real: 30 selos iguais).
    let nj = bdCnt.tot > 1 && !p.ausente && !(p.outroDia && !p.pt && !p.reserva) ? (bdCnt.cnt.get(p.id) || 0) : -1;
    if (nj === bdCnt.tot) nj = -1;
    const cntH = nj >= 0 ? '<span class="c-cnt' + (nj === 0 ? ' z' : nj === bdCnt.tot ? ' all' : '') + '" title="' + esc(t('cntTip').replace('%s', nj).replace('%t', bdCnt.tot)) + '">' + nj + '/' + bdCnt.tot + '</span>' : '';
    ...
    // Torre onde o player COMEÇA a partida — decisão do commander, por jogo. Clicar cicla
    // top → mid → bot → nenhuma. Só faz sentido para quem está escalado numa PT.
    const tor = (p.pt && !p.reserva) ? '<span class="c-tor' + (p.torre ? ' on t-' + p.torre : '') + '" data-tor="' + p.id + '" title="' + esc(t('torTip')) + '">' + (p.torre ? t('tor_' + p.torre) : '◦') + '</span>' : '';
    const sabs = (p.signupAusente ? '<span class="c-sabs" title="' + esc(t('signupAbsTip') || 'Marcou Absence no raid-helper — escalado mesmo assim') + '">⚠</span>' : '')
      + (p.extra ? '<span class="c-sabs c-extra" title="' + esc(t('extraTip')) + '">⤓</span>' : '')
      + (p.outroDia && (p.pt || p.reserva) ? '<span class="c-sabs" title="' + esc(t('outroDiaTip')) + '">↷</span>' : '')
      + (notaDe(p) ? '<span class="c-nota" title="📝 ' + esc(notaDe(p)) + '">📝</span>' : '');
    ...
    return '<div class="bd-chip" draggable="true" data-id="' + p.id + '" style="--rc:' + roleColor(p.funcao) + '">'
      + '<span class="c-grip">⋮⋮</span>' + icoHTML(p)
      + '<span class="c-name" title="' + esc(p.nome) + '">' + esc(nomeExib(p, 18)) + '</span>'
      + '<span class="c-tags">' + jgBadge(p) + tor + sabs + pin + tagsHtml + rep + bdFlagsHTML(p) + '</span>'
      + cntH + '<span class="c-role">' + p.funcao + '</span></div>';
  }
  ...
  // Vaga vazia vira um slot tracejado dizendo o que falta (Tank / Healer / DPS), pela
  // composição alvo do config: na tela compartilhada o buraco aparece sem ninguém contar.
  function slotsVazios(c, n) {
    const falta = [], comp = CFG.ptComp || {};
    CFG.roleOrder.forEach(f => { const a = (comp[f] && comp[f].alvo) || 0; for (let i = c[f] || 0; i < a; i++) falta.push(f); });
    let h = ''; const livres = Math.max(0, CFG.ptSize - n);
    for (let i = 0; i < livres; i++) { const f = falta[i]; h += '<div class="bd-slot"' + (f ? ' style="--rc:' + roleColor(f) + '"' : '') + '>' + (f ? '＋ ' + f : '＋') + '</div>'; }
    return h;
  }
  function renderBoard() {
    ...
    // Guerra de dois dias: quem não se inscreveu no dia do jogo aberto e não está escalado
    // vai para a faixa apagada "outro dia" — continua arrastável.
    const extraLivre = p => p.extra && !p.pt && !p.reserva;
    const fora = p => (p.outroDia || p.extra) && !p.pt && !p.reserva;
    const extras = byRole(active.filter(extraLivre));
    const pool = byRole(active.filter(p => !p.pt && !p.reserva && !fora(p))).sort((a, b) => (isMain(b) ? 1 : 0) - (isMain(a) ? 1 : 0));
    const gres = byRole(active.filter(p => !p.pt && p.reserva));
    const outros = byRole(active.filter(p => fora(p) && !p.extra));
    ...
    if (extras.length) side += '<div class="bd-zone bd-abs bd-outro bd-extra" data-zone="pool"><div class="bd-zh">' + t('extraZone') + ' <span class="bd-c">' + extras.length + '</span><button class="bd-extra-clr" title="' + esc(t('extraClear')) + '">✕ ' + t('extraClear') + '</button></div><div class="bd-chips">' + bdChipsHTML('extra', extras) + '</div></div>';
    if (outros.length) side += '<div class="bd-zone bd-abs bd-outro" data-zone="pool"><div class="bd-zh">' + t('bdOutroZone') + ' <span class="bd-c">' + outros.length + '</span></div><div class="bd-chips">' + bdChipsHTML('outro', outros) + '</div></div>';
    ...
    PT_IDS.forEach(pid => {
      ...
      const head = '<span class="dot" style="background:' + party.cor + '"></span><b>' + (state.ptIcon[pid] ? ptIconHTML(state.ptIcon[pid]) + ' ' : '') + pid + '</b>'
        ...
        + ((dupTargetGames().length && (tit.length || ptres.length)) ? '<button class="bd-dup-pt" data-dup2="' + pid + '" title="' + t('dupPtTitle') + '">↔</button>' : '');
      ...
      grid += '<div class="bd-pt-card">'
        ...
        + '<div class="bd-zone bd-pt" data-zone="' + pid + '"><div class="bd-chips">' + tit.map(bdChip).join('') + slotsVazios(c, tit.length) + '</div></div>'
    ...
    { const top = $('rmTop'); if (boardTools && top) { if (boardTools.parentNode !== top) top.appendChild(boardTools); boardTools.hidden = rosterView !== 'board'; } }
  ...
  function openBdPop(id, anchor) {
    const p = rosterDraft.find(x => x.id === id); if (!p || !bdPop) return; const outro = bdPopId !== id || bdPop.hidden; bdPopId = id; bdPopAnchor = anchor;
    let html = '<div class="bp-nm">' + esc(p.nome) + '</div>' + (notaDe(p) ? '<div class="bp-nota" title="' + esc(t('notaLbl')) + '">📝 ' + esc(notaDe(p)) + '</div>' : '') + '<div class="bp-sec">' + t('ptLbl') + '</div><div class="bp-row">';
    ...
    html += '</div>';
    // Um wrapper em volta de 📌 Fixar e ⇄ Replace de: o tour do Board destaca os dois de uma vez.
    html += '<div class="bp-block bp-block-lock">';
    html += '<div class="bp-row"><button class="bp-main' + (isMain(p) ? ' active' : '') + '">' + (isMain(p) ? '⭐ ' + t('mainOn') : '☆ ' + t('mainOff')) + '</button></div>';
    html += '<div class="bp-sec"><img class="bp-coin" src="../assets/icons/funcoin.png" alt=""> ' + t('jgLbl') + ' · ' + t('jgWar') + '</div><div class="bp-row bp-jgs">'
      + '<button class="bp-jg' + (!p.jg ? ' active' : '') + '" data-jg="">—</button>'
      + JG_CORES.map(c => '<button class="bp-jg' + (p.jg === c.id ? ' active' : '') + '" data-jg="' + c.id + '" style="--jg:' + c.c + '"><i></i>' + esc(t('jg_' + c.id)) + '</button>').join('') + '</div>';
    ...
    html += '</div></div>';
    if (dupTargetGames().length) html += '<div class="bp-row"><button class="bp-dup">' + t('dupBtn') + '</button></div>';
    bdPop.innerHTML = html; bdPop.hidden = false;
    if (outro) bdPop.scrollTop = 0;   // player novo abre do topo (antes herdava a rolagem do anterior e escondia a linha de PT)
    placeBdPop(anchor);
  }
  function placeBdPop(anchor) {
    if (!bdPop || !anchor) return;
  ...
  function projectData() { stashJogoAtual(); return { app: 'zhi-estrategia', v: 6, exportedAt: new Date().toISOString(), currentId: state.currentId, roster: state.roster, ptDesc: state.ptDesc, ptIcon: state.ptIcon, objetivoPosGlobal: state.objetivoPosGlobal, gates: state.gates, side: state.side, showNames: state.showNames, rhEvent: state.rhEvent || undefined, rhEvent2: state.rhEvent2 || undefined, jogos: state.jogos.length ? state.jogos : undefined, jogoAtual: state.jogos.length ? state.jogoAtual : undefined, cenarios: state.scenarios }; }
  ...
  function applyImported(d) { if (typeof d.v === 'number' && d.v > PLAN_V && !confirm(t('vNewer') || 'Este plano foi feito numa versão mais nova do Game Plan. Abrir aqui pode descartar partes que esta versão não entende (e sobrescrever o plano). Continuar?')) return false; const scenarios = Array.isArray(d.cenarios) ? d.cenarios : (Array.isArray(d.scenarios) ? d.scenarios : null); if (!scenarios || !scenarios.length) { alert(t('noScenes')); return false; } state.scenarios = scenarios.map(sanitizeScenario); state.roster = Array.isArray(d.roster) ? d.roster.map(sanitizePlayer) : []; cleanupReplaces(state.roster); state.objetivoPosGlobal = sanitizePosMap(d.objetivoPosGlobal); state.gates = sanitizePosMap(d.gates); state.side = (d.side === 'blue' || d.side === 'red') ? d.side : null; state.ptDesc = sanitizeDesc(d.ptDesc); state.ptIcon = sanitizeDesc(d.ptIcon); if (typeof d.showNames === 'boolean') state.showNames = d.showNames; if (typeof d.rhEvent === 'string' && d.rhEvent) state.rhEvent = d.rhEvent; state.rhEvent2 = typeof d.rhEvent2 === 'string' ? d.rhEvent2 : ''; if (Array.isArray(d.jogos) && d.jogos.length) { state.jogos = d.jogos.map(sanitizeJogo); state.jogoAtual = state.jogos.some(j => j.id === d.jogoAtual) ? d.jogoAtual : state.jogos[0].id; applyEscalacao(state.jogos.find(j => j.id === state.jogoAtual)); } else { state.jogos = []; state.jogoAtual = null; } state.currentId = d.currentId && state.scenarios.some(s => s.id === d.currentId) ? d.currentId : state.scenarios[0].id; hidePopover(); renderRail(); loadScenarioIntoUI(); renderDrawings(); renderObjectives(); renderSidebar(); renderTokens(); renderJogos(); saveProject(); return true; }
  ...
  // ☁ Link curto: o board vai para o Worker do zhi-signups (/api/boards/<nome>) e o link
  // vira ?s=<nome>. Ler é aberto; regravar pede a senha definida no primeiro salvamento.
  const BOARDS_API = 'https://zhi-signups.guilherme-99b.workers.dev/api/boards/';
  function boardPayload() { stashJogoAtual(); return { app: 'zhi-board', v: 2, roster: state.roster.map(slimPlayer), ptDesc: state.ptDesc, ptIcon: state.ptIcon, jogos: state.jogos.length ? state.jogos : undefined, jogoAtual: state.jogos.length ? state.jogoAtual : undefined, rhEvent: state.rhEvent || undefined, rhEvent2: state.rhEvent2 || undefined }; }
  function slugBoard(v) { return String(v || '').trim().toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, '').replace(/[^a-z0-9]+/g, '-').replace(/^-+|-+$/g, '').slice(0, 40); }
  async function salvarNuvem() {
    // O que está no board aberto (rascunho) é o que vale salvar.
    if (rosterModal && !rosterModal.hidden) applyRosterDraft();
    const nome = slugBoard(prompt(t('cloudNameAsk'), state.cloudName || ''));
    if (!nome) return;
    if (nome.length < 3) { toast('⚠️ ' + t('cloudNameBad')); return; }
    const senha = prompt(t('cloudPassAsk'));
    if (!senha) return;
    let r, j = {};
    try { r = await fetch(BOARDS_API + nome, { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ senha, data: boardPayload() }) }); j = await r.json().catch(() => ({})); }
    catch (e) { toast('⚠️ ' + t('cloudFail')); return; }
    if (r.status === 403) { toast('⚠️ ' + t('cloudWrongPass')); return; }
    if (!r.ok) { toast('⚠️ ' + (j.error || t('cloudFail'))); return; }
    state.cloudName = nome; saveProject();
    const url = location.origin + location.pathname + '?s=' + nome;
    { const tp = $('shareTitleP'); if (tp) tp.textContent = t('cloudSavedTitle'); }
    shareUrl.value = url; shareModal.hidden = false; shareUrl.focus(); shareUrl.select();
    try { await navigator.clipboard.writeText(url); } catch (e) {}
    toast('☁ ' + t(j.created ? 'cloudCreated' : 'cloudUpdated'));
  }
  // ?s=<nome> na URL: abre o board salvo. O ?s continua na barra para dar F5 e pegar a versão nova.
  async function maybeLoadCloud() {
    const nome = slugBoard(new URLSearchParams(location.search).get('s'));
    if (!nome) return;
    let r, j;
    try { r = await fetch(BOARDS_API + nome, { cache: 'no-store' }); j = await r.json(); } catch (e) { toast('⚠️ ' + t('cloudFail')); return; }
    if (!r.ok || !j || !j.data) { toast('⚠️ ' + t('cloudNotFound')); return; }
    const d = j.data;
    if (typeof d.rhEvent === 'string') state.rhEvent = d.rhEvent;
    state.rhEvent2 = typeof d.rhEvent2 === 'string' ? d.rhEvent2 : '';
    state.cloudName = nome;
    applyBoardData(d);
    toast('☁ ' + t('cloudLoaded') + ' ' + nome);
    return true;
  }
  ...
  function slimPlayer(p) {
    ...
    if (p.torre) o.torre = p.torre;
    if (p.funcaoBase && p.funcaoBase !== p.funcao) o.funcaoBase = p.funcaoBase;
    if (p.manual) o.manual = 1;
    if (p.extra) o.extra = 1;
    if (p.jg) o.jg = p.jg;
    if (p.specEmote) o.specEmote = p.specEmote;
    if (p.spec) o.spec = p.spec;
    if (p.tags && p.tags.length) o.tags = p.tags;
    if (p.flags && p.flags.length) o.flags = p.flags;
    if (p.nota) o.nota = p.nota;
    if (p.dias) o.dias = p.dias;
    if (p.notas) o.notas = p.notas;
    if (p.outroDia) o.outroDia = 1;
    return o;
  }
  function applyBoardData(d) {
    ...
    if (Array.isArray(d.jogos) && d.jogos.length) {
      ...
      applyEscalacao(state.jogos.find(j => j.id === state.jogoAtual));
    }
  ...
  // Segundo tour, sob demanda: DENTRO do Board (botao 🎓). Chave PROPRIA, para nao marcar
  // nem depender da chave do tour de boas-vindas. Nenhum dos dois se abre sozinho.
  const TOUR_BOARD_KEY = 'zhi_gp_tour_board_v1';
  let tourIdx = -1, tourMode = 'main';
  // Um motor so: tourShow/tourNext/tourEnd leem esta lista, que troca conforme o tour vivo.
  function tourSteps() { return tourMode === 'board' ? boardTourSteps() : mainTourSteps(); }
  function mainTourSteps() {
    return [
      ...
      { sel: '#rosterModal .modal', k: 6, img: 'boardLink', open: () => { if (rosterModal.hidden) openRoster(); }, close: () => closeRoster(true) },
      { sel: '#warsBtn', k: 7 },
      { sel: '#liveBtn', k: 8 },
      { sel: '#shareBtn', k: 9 },
      { sel: '#helpBtn', k: 10 }
  ...
  // ---- tour do Board (sob demanda, pelo botao 🎓 das ferramentas do board) ----
  // Chip de TITULAR do jogo atual: e o popover dele que tem 📌 Fixar, entao os passos do
  // popover precisam de alguem escalado, nao de um reserva do pool.
  function bdTourChip() {
    const grid = document.querySelector('#rosterModal .bd-grid'); if (!grid) return null;
    const chips = [].slice.call(grid.querySelectorAll('.bd-chip'));
    return chips.find(c => { const p = rosterDraft.find(x => x.id === c.dataset.id); return p && p.pt && !p.reserva; }) || chips[0] || null;
  }
  function bdTourPop() { const c = bdTourChip(); if (c) openBdPop(c.dataset.id, c); }
  // O tour do Board roda com o modal aberto, na vista Board. O passo do menu ⋯ precisa do topo
  // da tela visivel, entao ele esconde o modal por VISIBILIDADE: fecha-lo de verdade poderia
  // perguntar sobre salvar o rascunho no meio do tour. O passo seguinte ja o traz de volta.
  function bdTourBoard() {
    if (rosterModal.hidden) openRoster();
    if (rosterView !== 'board') setRosterView('board');
    if (rosterModal) rosterModal.style.visibility = '';
  }
  function boardTourSteps() {
    const passo = (k, sel, extra) => Object.assign({ k: k, sel: sel, tk: 'btT', dk: 'btD' }, extra || {});
    return [
      // 1 · a barra de jogos dentro do Board (G1..Gn, + duplica, Alt+clique vazio, × apaga)
      passo(1, '#jogoBarRoster', { open: bdTourBoard }),
      // 2 · ligar o eixo de jogos: o item do menu fica destacado, nao so citado no texto
      passo(2, '#jogosOnBtn', {
        open: () => { bdTourBoard(); if (rosterModal) rosterModal.style.visibility = 'hidden'; const mm = $('moreMenu'); if (mm) mm.hidden = false; },
        close: () => { const mm = $('moreMenu'); if (mm) mm.hidden = true; if (rosterModal) rosterModal.style.visibility = ''; }
      }),
      // 3 · a escalacao e do jogo ATUAL
      passo(3, '#rosterModal .bd-grid', { open: bdTourBoard }),
      // 4 · Grade ▦
      passo(4, '#jogoBarRoster .jogo-grade', { open: bdTourBoard }),
      // 5..7 · popover do player (aberto como o usuario abre: clique no chip)
      passo(5, '#bdPop', { open: () => { bdTourBoard(); bdTourPop(); } }),
      passo(6, '#bdPop .bp-block-lock', { open: () => { bdTourBoard(); bdTourPop(); } }),
      passo(7, '#bdPop .bp-dup', {
        open: () => { bdTourBoard(); bdTourPop(); },
        close: () => { if (bdPop) bdPop.hidden = true; }
      }),
      // 8 · ↔ do cabecalho da PT
      passo(8, '#rosterModal .bd-grid .bd-dup-pt', { open: bdTourBoard })
    ];
  }
  function boardTourStart() {
    if (bdPop) bdPop.hidden = true;          // o popover aberto sai de cena antes do tour
    tourMode = 'board';
    try { localStorage.setItem(TOUR_BOARD_KEY, '1'); } catch (e) {}
    bdTourBoard();
    tourIdx = -1; tourNext(1);
  }
  ...
  function tourEnd() { const s = tourSteps()[tourIdx]; if (s && s.close) { try { s.close(); } catch (e) {} } tourIdx = -1; tourMode = 'main'; const { ov, hole, card } = tourEls(); if (ov) ov.hidden = true; if (hole) hole.hidden = true; if (card) card.hidden = true; }
  ...
  function tourShow(s) {
    ...
    card.hidden = false;
    card.innerHTML = '<div class="tc-step">' + (tourIdx + 1) + ' / ' + steps.length + '</div><div class="tc-t">' + t((s.tk || 'tourT') + s.k) + '</div><div class="tc-d">' + t((s.dk || 'tourD') + s.k) + '</div>'
  ...
  function tourImgHTML(key) {
    const src = (CFG.assets && CFG.assets.prints && CFG.assets.prints[key]) || '';
    if (!src) return '';
    return '<img class="tc-img" src="' + src + '" alt="" data-zoom="1"><div class="tc-cap">' + t('tourBdImg') + '</div>';
  }
  /* ampliar a print: registra o Esc em fase de CAPTURA pra fechar o zoom sem
     encerrar o tour (o listener do tour esta no bubble) */
  function zoomImg(src) {
    if (document.querySelector('.tc-zoom')) return;
    const wrap = document.createElement('div'); wrap.className = 'tc-zoom';
  ...
  function tourIntroShow() {
    ...
    novo.innerHTML = '<div class="lg-pills tour-prefs">' + langPillsHTML() + '<span class="tp-sep"></span>' + temaPillsHTML() + '</div>';
    row.replaceWith(novo.firstElementChild);
    wireLangPills(im.querySelector('.tour-prefs'), () => { if (tourIdx >= 0) tourShow(tourSteps()[tourIdx]); tourIntroShow(); });
    im.querySelectorAll('[data-tm]').forEach(b => { b.onclick = ev => { ev.preventDefault(); ev.stopPropagation(); setTema(b.getAttribute('data-tm')); tourIntroShow(); }; });
  }
  function maybeTour() {
    if (isMobile()) return;
    try { if (localStorage.getItem(TOUR_KEY)) return; } catch (e) { return; }
    if (location.hash || /[?&](plan|rh)=/.test(location.search)) return;
  ...
  function updateWarsBtn() { const l = $('warsLbl'); if (!l) return; const r = warsReg(); const w = r.list.find(x => x.id === r.cur); const wn = w ? warNome(w.nome) : ''; l.textContent = w ? (wn.length > 16 ? wn.slice(0, 15) + '…' : wn) : t('wars'); }
  ...
  function renderPtIcons() {
    ...
    let html = '<button class="none' + (cur ? '' : ' sel') + '" data-i="">' + esc(t('ptIconNone')) + '</button>';
  ...
  function renderPtEditor() {
    ...
    let html = '';
    if (!tit.length && !res.length) html += '<div class="pe-empty">' + esc(t('peNoMembers')) + '</div>';
    tit.concat(res).forEach(m => html += '<div class="pe-mem' + (m.reserva ? ' res' : '') + '"><span class="rl" style="background:' + roleColor(m.funcao) + '"></span><span class="nm">' + esc(m.nome) + memBadges(m) + '</span><span class="cl">' + m.funcao + (m.reserva ? ' · res' : '') + '</span><button class="rm" data-id="' + m.id + '" title="' + esc(t('peRemoveTip')) + '">✕</button></div>');
  ...
  function fillAddSel() {
    ...
    peAddSel.innerHTML = avail.length ? avail.map(p => '<option value="' + p.id + '">' + esc(p.nome) + ' · ' + p.funcao + (p.pt ? ' (' + p.pt + ')' : p.reserva ? ' (res)' : '') + '</option>').join('') : '<option value="">' + esc(t('peNoAvail')) + '</option>';
  }
  ...
  function wireEvents() {
    ...
    { const sb = $('specIcoBtn'); if (sb) {
        const rot = () => { sb.classList.toggle('on', specIcons); const sp = sb.querySelector('span'); if (sp) sp.textContent = t('mSpecIco') + (specIcons ? ' ✓' : ''); };
        rot();
        sb.addEventListener('click', () => {
          specIcons = !specIcons;
          try { localStorage.setItem('gp-spec-icons', specIcons ? '1' : '0'); } catch (e) {}
          rot(); renderSidebar(); if (rosterModal && !rosterModal.hidden) refreshRoster();
          const mm = $('moreMenu'); if (mm) mm.hidden = true;
          toast(t(specIcons ? 'specIcoOn' : 'specIcoOff'));
        });
      } }
    ...
    { const gm = $('gradeModal'), gc = $('gradeClose'), gp = $('gradePng'), gs = $('gradeTabs');
      ...
      if (gs) gs.addEventListener('click', e => {
        const b = e.target.closest('[data-gm]'); if (!b || b.dataset.gm === gradeMode) return;
        gradeMode = b.dataset.gm; renderGrade(); syncGradeSwap();
      });
      syncGradeSwap(); }
    ...
    { const mb = $('moreBtn'), mm = $('moreMenu');
      if (mb && mm) {
        ...
        document.addEventListener('click', e => { if (!mm.hidden && !e.target.closest('.plans-wrap') && !e.target.closest('#tourCard')) mm.hidden = true; });
      } }
    ...
    shareCopy.addEventListener('click', async () => { shareUrl.focus(); shareUrl.select(); let ok = false; try { await navigator.clipboard.writeText(shareUrl.value); ok = true; } catch (e) {} if (!ok) { try { ok = document.execCommand('copy'); } catch (e) {} } toast(ok ? t('linkCopied') : t('selectCopy')); });
    ...
    { const rl = $('rhLink'), rs = $('rhSync'); if (rs) rs.addEventListener('click', async () => {
      ...
      const rl2 = $('rhLink2'), v2 = (rl2 && rl2.value || '').trim();
      if (!id) { parseMsg.className = 'parse-msg err'; parseMsg.textContent = t('rhNoLink'); return; }
      if (v !== state.rhEvent || v2 !== (state.rhEvent2 || '')) { state.rhEvent = v; state.rhEvent2 = rhEventId(v2) ? v2 : ''; saveProject(); }
      if (state.rhEvent2) { state.roster = rosterDraft.map(x => Object.assign({}, x)); ligarDias(); rosterDraft = state.roster.map(x => Object.assign({}, x, { flags: (x.flags || []).slice() })); renderJogos(); }
      parseMsg.className = 'parse-msg'; parseMsg.textContent = '…';
      let parsed; try { parsed = await fetchRoster(); } catch (e) { parseMsg.className = 'parse-msg err'; parseMsg.textContent = t('rhFail'); return; }
      if (!rosterDraft.length) { rosterDraft = parsed; rosterDraft.forEach(p => { if (p.dias) diaStatus(p, diaAtual()); }); parseMsg.className = 'parse-msg ok'; parseMsg.textContent = parsed.length + ' ' + t('rosterOk'); }
    ...
    // Jogador que não se inscreveu no raid-helper (ou entrou de última hora) entra por aqui.
    // Fica sem `disc`, então não vira menção no Discord — nada a fazer, o id é de lá.
    { const ap = $('addPlayerBtn'); if (ap) ap.addEventListener('click', () => {
        const nome = (prompt(t('addPlayerAsk')) || '').trim();
        if (!nome) return;
        const norm = x => (x || '').trim().toLowerCase();
        if (rosterDraft.some(p => norm(p.nome) === norm(nome))) { toast(t('addPlayerDup')); return; }
        pushBdUndo();
        rosterDraft.push({ id: uid(), nome: nome.slice(0, 40), classe: 'DPS', funcao: 'DPS', status: 'primary', ausente: false, reserva: false, pt: null, tags: [], flags: [], replace: false, manual: true, nota: '' });
        refreshRoster();
        toast(t('addPlayerOk'));
      }); }
    { const pb = $('bdPresent'); if (pb) pb.addEventListener('click', () => { rosterModal.classList.toggle('bd-telao'); pb.classList.toggle('on', rosterModal.classList.contains('bd-telao')); });
      document.addEventListener('keydown', ev2 => { if (ev2.key === 'Escape' && rosterModal && rosterModal.classList.contains('bd-telao')) { rosterModal.classList.remove('bd-telao'); if (pb) pb.classList.remove('on'); ev2.stopPropagation(); } }, true); }
    { const xb = $('extraBtn'); if (xb) xb.addEventListener('click', () => { const v = prompt(t('extraAsk')); if (v) puxarExtras(v); }); }
    ...
    // Tema: o mesmo seletor no board e na Grade; trocar re-renderiza tudo que pinta cor de função.
    temaSelFill();
    document.querySelectorAll('.tema-sel').forEach(sel => {
      sel.addEventListener('change', () => setTema(sel.value));
    });
    { const bc = $('bdCloud'); if (bc) bc.addEventListener('click', salvarNuvem); }
    { const bt = $('bdTour'); if (bt) bt.addEventListener('click', boardTourStart); }
    ...
    rosterBoard.addEventListener('click', e => {
      if (e.target.closest('.bd-extra-clr')) {   // tira os puxados que não estão escalados em nenhum jogo
        e.stopPropagation(); stashJogoAtual();
        const usado = id => state.jogos.some(j => { const x = (j.escalacao || {})[id]; return x && (x.pt || x.reserva); });
        pushBdUndo(); rosterDraft = rosterDraft.filter(p => !(p.extra && !p.pt && !p.reserva && !usado(p.id))); refreshRoster(); return;
      }
      const tb = e.target.closest('.c-tor');
      if (tb) {
        e.stopPropagation();
        const pl = rosterDraft.find(x => x.id === tb.dataset.tor);
        if (pl) { pushBdUndo(); const i = TORRES.indexOf(pl.torre); pl.torre = i < 0 ? TORRES[0] : (TORRES[i + 1] || undefined); refreshRoster(); }
        return;
      }
      ...
      const dp = e.target.closest('.bd-dup-pt');
      if (dp) { const pid = dp.dataset.dup2; const pids = rosterDraft.filter(x => x.pt === pid && !x.ausente).map(x => x.id); if (pids.length) openDupChooser(pids, pid, dp, 'pt'); else toast(t('dupNoPlace')); return; }
      const c = e.target.closest('.bd-chip'); if (c) openBdPop(c.dataset.id, c);
    });
    bdPop.addEventListener('click', e => {
      /* levar a posição/PT para outros jogos: abre o seletor de jogos dentro do próprio popover */
      const du = e.target.closest('.bp-dup');
      if (du) {
        const p = rosterDraft.find(x => x.id === bdPopId);
        if (!p) return;
        if (!p.pt && !p.reserva && !p.torre) { toast(t('dupNoPlace')); return; }
        openDupChooser([p.id], p.nome, bdPopAnchor); return;
      }
      const gall = e.target.closest('.bp-gall'); if (gall) { bdPop.querySelectorAll('.bp-g input').forEach(i => { i.checked = true; }); return; }
      const gnone = e.target.closest('.bp-gnone'); if (gnone) { bdPop.querySelectorAll('.bp-g input').forEach(i => { i.checked = false; }); return; }
      const ggo = e.target.closest('.bp-dup-go');
      if (ggo) {
        const el = bdPop.querySelector('.bp-dup-pids'); const pids = el ? el.value.split(',').filter(Boolean) : [];
        const ids = [].slice.call(bdPop.querySelectorAll('.bp-g input:checked')).map(i => i.dataset.g);
        if (!ids.length) { toast(t('dupNone')); return; }
        const n = dupToGames(pids, ids);
        if (n) toast((n === 1 ? t(pids.length > 1 ? 'dupPtOk1' : 'dupOk1') : t(pids.length > 1 ? 'dupPtOkN' : 'dupOkN')).replace('%s', n));
        bdPop.hidden = true; return;
      }
      const gcx = e.target.closest('.bp-dup-cancel');
      if (gcx) { if (bdDupOrigin === 'player' && bdPopId && bdPopAnchor) openBdPop(bdPopId, bdPopAnchor); else bdPop.hidden = true; return; }
      ...
      if (e.target.closest('.bp-main')) { toggleMain(p); refreshRoster(); openBdPop(p.id, bdPopAnchor); return; }
      { const jb = e.target.closest('.bp-jg'); if (jb) { pushBdUndo(); if (jb.dataset.jg) p.jg = jb.dataset.jg; else delete p.jg; refreshRoster(); openBdPop(p.id, bdPopAnchor); return; } }
    ...
    document.addEventListener('click', e => { if (bdPop && !bdPop.hidden && !e.target.closest('#bdPop') && !e.target.closest('.bd-chip') && !e.target.closest('#tourCard')) bdPop.hidden = true; });
    ...
    rosterGrid.addEventListener('click', e => {
      const nm = e.target.closest('.ednm'); if (!nm) return;
      const row = nm.closest('.rrow'); if (!row) return;
      const p = rosterDraft[+row.dataset.i]; if (!p) return;
      // Mostra o nome real como referência: é ele que casa com o raid-helper no sync.
      const v = prompt(t('nickAsk') + '\n\n' + p.nome, p.apelido || '');
      if (v === null) return;
      pushBdUndo();
      p.apelido = v.trim() ? v.trim().slice(0, 24) : undefined;
      refreshRoster();
    });
  ...
  // ---- persistência ----
  function saveProject() { stashJogoAtual(); try { localStorage.setItem(CFG.projectKey, JSON.stringify({ v: 6, currentId: state.currentId, scenarios: state.scenarios, roster: state.roster, ptDesc: state.ptDesc, ptIcon: state.ptIcon, objetivoPosGlobal: state.objetivoPosGlobal, gates: state.gates, side: state.side, showNames: state.showNames, rhEvent: state.rhEvent || '', rhEvent2: state.rhEvent2 || '', cloudName: state.cloudName || '', jogos: state.jogos, jogoAtual: state.jogoAtual })); } catch (e) {} if (LIVE.on && !LIVE.applying && livePenMine()) liveScheduleTx(); }
  function loadProject() { try { const raw = localStorage.getItem(CFG.projectKey); if (raw) { const d = JSON.parse(raw); if (Array.isArray(d.scenarios) && d.scenarios.length) { state.scenarios = d.scenarios.map(sanitizeScenario); state.currentId = d.currentId && state.scenarios.some(s => s.id === d.currentId) ? d.currentId : state.scenarios[0].id; if (Array.isArray(d.roster)) state.roster = d.roster.map(sanitizePlayer); state.objetivoPosGlobal = sanitizePosMap(d.objetivoPosGlobal); state.gates = sanitizePosMap(d.gates); state.side = (d.side === 'blue' || d.side === 'red') ? d.side : null; state.ptDesc = sanitizeDesc(d.ptDesc); state.ptIcon = sanitizeDesc(d.ptIcon); if (typeof d.showNames === 'boolean') state.showNames = d.showNames; if (typeof d.rhEvent === 'string') state.rhEvent = d.rhEvent; if (typeof d.rhEvent2 === 'string') state.rhEvent2 = d.rhEvent2; if (typeof d.cloudName === 'string') state.cloudName = d.cloudName; if (Array.isArray(d.jogos)) { state.jogos = d.jogos.map(sanitizeJogo); state.jogoAtual = state.jogos.some(j => j.id === d.jogoAtual) ? d.jogoAtual : (state.jogos[0] ? state.jogos[0].id : null); } return; } } } catch (e) {} const s = newScenario({ fase: 'Start', nome: 'Start (30m)' }); state.scenarios = [s]; state.currentId = s.id; }
  ...
  function sanitizePlayer(p) { const funcao = ['Tank', 'DPS', 'Healer'].includes(p.funcao) ? p.funcao : 'DPS'; const funcaoBase = ['Tank', 'DPS', 'Healer'].includes(p.funcaoBase) ? p.funcaoBase : funcao; const flagIds = (CFG.specialFlags || []).map(f => f.id); return { id: p.id || uid(), nome: String(p.nome || '—'), classe: String(p.classe || funcao), funcao, funcaoBase, status: p.status || 'primary', ausente: !!p.ausente, reserva: !!p.reserva, pt: PT_IDS.includes(p.pt) ? p.pt : null, tags: (Array.isArray(p.tags) ? p.tags : (p.tag2 ? [p.tag2] : [])).filter(tg => (CFG.secondaryTags || []).includes(tg)), flags: Array.isArray(p.flags) ? p.flags.filter(f => flagIds.includes(f)) : [], replace: !!p.replace, replaceOf: (typeof p.replaceOf === 'string' && p.replaceOf.trim()) ? String(p.replaceOf).slice(0, 40) : undefined, disc: (typeof p.disc === 'string' && /^\d{5,20}$/.test(p.disc)) ? p.disc : undefined, fix: PT_IDS.includes(p.fix) ? p.fix : undefined, signupAusente: p.signupAusente ? true : undefined, manual: p.manual ? true : undefined, extra: p.extra ? true : undefined, jg: ['vermelha','branca','amarela','verde'].indexOf(p.jg) >= 0 ? p.jg : undefined, spec: (typeof p.spec === 'string' && p.spec) ? p.spec.slice(0, 40) : undefined, specEmote: (typeof p.specEmote === 'string' && /^\d{5,20}$/.test(p.specEmote)) ? p.specEmote : undefined, torre: (['top','mid','bot'].indexOf(p.torre) >= 0) ? p.torre : undefined, apelido: (typeof p.apelido === 'string' && p.apelido.trim()) ? p.apelido.trim().slice(0, 24) : undefined, nota: typeof p.nota === 'string' ? p.nota : '', dias: sanitizeDias(p.dias), notas: sanitizeNotas(p.notas), outroDia: p.outroDia ? true : undefined }; }
  function sanitizeDias(o) { if (!o || typeof o !== 'object') return undefined; const r = {}; DIAS.forEach(d => { if (o[d] === 'in' || o[d] === 'aus') r[d] = o[d]; }); return Object.keys(r).length ? r : undefined; }
  function sanitizeNotas(o) { if (!o || typeof o !== 'object') return undefined; const r = {}; DIAS.forEach(d => { if (typeof o[d] === 'string' && o[d]) r[d] = o[d].slice(0, 200); }); return Object.keys(r).length ? r : undefined; }
})();
