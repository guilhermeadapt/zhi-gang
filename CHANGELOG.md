...
| v118 | 26/09/2026 | GamePlan v118: visão Planilha da Grade consertada nos 4 temas e na 🖼 Imagem: letra da torre dentro da célula, na mesma linha do nome, e todas as linhas com a mesma altura; cabeçalho PT1…PT6 em pílula clara na cor da PT (contraste ≥ 4,5:1); célula que mudou em relação ao jogo anterior ganha só uma moldura, sem faixa de fundo; nome do jogo (ex.: SÁB G1) numa faixa acima da tabela, sem corte, e as colunas de PT ficam mais largas | — |
